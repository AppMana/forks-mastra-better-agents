...
Xn(Zr, {
  ...
  print: () => Yr,
  printComment: () => Wp,
  printPrettierIgnored: () => Yr,
  willPrintOwnComments: () => gi,
});
var Rn =
    (e, t) =>
    (n, r, ...u) =>
      n | 1 && r == null ? void 0 : (t.call(r) ?? r[e]).apply(r, u),
  ys =
...
var lt = ks;
function ws(e, t, n = {}) {
  let r = pt(e, n.backwards ? t - 1 : t, n),
    u = lt(e, r, n);
  return r !== u;
}
var oe = ws;
...
var _ = Ms,
  Ls = () => {},
  Os = Ls,
  tu = Object.freeze({ character: "'", codePoint: 39 }),
  nu = Object.freeze({ character: '"', codePoint: 34 }),
  Js = Object.freeze({ preferred: tu, alternate: nu }),
  qs = Object.freeze({ preferred: nu, alternate: tu });
function Xs(e, t) {
  let { preferred: n, alternate: r } = t === !0 || t === "'" ? Js : qs,
    { length: u } = e,
    a = 0,
    s = 0;
  for (let o = 0; o < u; o++) {
...
function _s(e, t) {
  let n = t === '"' ? "'" : '"',
    r = z(0, e, Rs, (u, a, s) => (a ? (a === n ? n : u) : s === t ? '\\' + s : s));
  return t + r + t;
}
var Ws = _s;
function Us(e, t) {
...
function bt(e) {
  ...
  return ((xt = bt.prototype = e ?? Object.create(null)), new bt());
}
var Vs = 10;
...
var au = Hs,
  ...
  zs = {
    AccessorProperty: i[0],
    AnyTypeAnnotation: i[1],
    ArgumentPlaceholder: i[1],
    ArrayExpression: ['elements'],
    ArrayPattern: ['elements', 'typeAnnotation', 'decorators'],
    ArrayTypeAnnotation: i[2],
    ArrowFunctionExpression: ['typeParameters', 'params', 'predicate', 'returnType', 'body'],
    AsConstExpression: i[3],
    AsExpression: i[4],
    AssignmentExpression: i[5],
    AssignmentPattern: ['left', 'right', 'decorators', 'typeAnnotation'],
    AwaitExpression: i[6],
    BigIntLiteral: i[1],
    BigIntLiteralTypeAnnotation: i[1],
    BigIntTypeAnnotation: i[1],
    BinaryExpression: i[5],
    BindExpression: ['object', 'callee'],
    BlockStatement: i[7],
    BooleanLiteral: i[1],
    BooleanLiteralTypeAnnotation: i[1],
    BooleanTypeAnnotation: i[1],
    BreakStatement: i[8],
    CallExpression: i[9],
    CatchClause: ['param', 'body'],
    ChainExpression: i[3],
    ClassAccessorProperty: i[0],
    ClassBody: i[10],
    ClassDeclaration: i[11],
    ClassExpression: i[11],
    ClassImplements: i[12],
    ClassMethod: i[13],
    ClassPrivateMethod: i[13],
    ClassPrivateProperty: i[14],
    ClassProperty: i[14],
    ...
    ComponentTypeParameter: i[15],
    ConditionalExpression: i[16],
    ConditionalTypeAnnotation: i[17],
    ContinueStatement: i[8],
    DebuggerStatement: i[1],
    DeclareClass: ['id', 'typeParameters', 'extends', 'mixins', 'implements', 'body'],
    DeclareComponent: ['id', 'params', 'rest', 'typeParameters', 'rendersType'],
    DeclaredPredicate: i[18],
    DeclareEnum: i[19],
    DeclareExportAllDeclaration: ['source', 'attributes'],
    DeclareExportDeclaration: i[20],
    DeclareFunction: ['id', 'predicate'],
    DeclareHook: i[21],
    DeclareInterface: i[22],
    DeclareModule: i[19],
    DeclareModuleExports: i[23],
    DeclareNamespace: i[19],
    DeclareOpaqueType: ['id', 'typeParameters', 'supertype', 'lowerBound', 'upperBound'],
    DeclareTypeAlias: i[24],
    DeclareVariable: i[21],
    Decorator: i[3],
    Directive: i[18],
    DirectiveLiteral: i[1],
    DoExpression: i[10],
    DoWhileStatement: i[25],
    EmptyStatement: i[1],
    EmptyTypeAnnotation: i[1],
    EnumBigIntBody: i[26],
    EnumBigIntMember: i[27],
    EnumBooleanBody: i[26],
    EnumBooleanMember: i[27],
    EnumDeclaration: i[19],
    EnumDefaultedMember: i[21],
    EnumNumberBody: i[26],
    EnumNumberMember: i[27],
    EnumStringBody: i[26],
    EnumStringMember: i[27],
    EnumSymbolBody: i[26],
    ExistsTypeAnnotation: i[1],
    ExperimentalRestProperty: i[6],
    ExperimentalSpreadProperty: i[6],
    ExportAllDeclaration: ['source', 'attributes', 'exported'],
    ExportDefaultDeclaration: ['declaration'],
    ExportDefaultSpecifier: i[28],
    ExportNamedDeclaration: i[20],
    ExportNamespaceSpecifier: i[28],
    ExportSpecifier: ['local', 'exported'],
    ExpressionStatement: i[3],
    File: ['program'],
    ForInStatement: i[29],
    ForOfStatement: i[29],
    ForStatement: ['init', 'test', 'update', 'body'],
    FunctionDeclaration: i[30],
    FunctionExpression: i[30],
    FunctionTypeAnnotation: ['typeParameters', 'this', 'params', 'rest', 'returnType'],
    FunctionTypeParam: i[15],
    GenericTypeAnnotation: i[12],
    HookDeclaration: i[31],
    HookTypeAnnotation: ['params', 'returnType', 'rest', 'typeParameters'],
    Identifier: ['typeAnnotation', 'decorators'],
    IfStatement: i[16],
    ImportAttribute: i[32],
    ImportDeclaration: ['specifiers', 'source', 'attributes'],
    ImportDefaultSpecifier: i[33],
    ImportExpression: ['source', 'options'],
    ImportNamespaceSpecifier: i[33],
    ImportSpecifier: ['imported', 'local'],
    IndexedAccessType: i[34],
    InferredPredicate: i[1],
    InferTypeAnnotation: i[35],
    InterfaceDeclaration: i[22],
    InterfaceExtends: i[12],
    InterfaceTypeAnnotation: ['extends', 'body'],
    InterpreterDirective: i[1],
    IntersectionTypeAnnotation: i[36],
    JsExpressionRoot: i[37],
    JsonRoot: i[37],
    JSXAttribute: ['name', 'value'],
    JSXClosingElement: ['name'],
    JSXClosingFragment: i[1],
    JSXElement: ['openingElement', 'children', 'closingElement'],
    JSXEmptyExpression: i[1],
    JSXExpressionContainer: i[3],
    JSXFragment: ['openingFragment', 'children', 'closingFragment'],
    JSXIdentifier: i[1],
    JSXMemberExpression: i[38],
    JSXNamespacedName: ['namespace', 'name'],
    JSXOpeningElement: ['name', 'typeArguments', 'attributes'],
    JSXOpeningFragment: i[1],
    JSXSpreadAttribute: i[6],
    JSXSpreadChild: i[3],
    JSXText: i[1],
    KeyofTypeAnnotation: i[6],
    LabeledStatement: ['label', 'body'],
    Literal: i[1],
    LogicalExpression: i[5],
    MatchArrayPattern: ['elements', 'rest'],
    MatchAsPattern: ['pattern', 'target'],
    MatchBindingPattern: i[21],
    MatchExpression: i[39],
    MatchExpressionCase: i[40],
    MatchIdentifierPattern: i[21],
    MatchLiteralPattern: i[41],
    ...
    MatchRestPattern: i[6],
    MatchStatement: i[39],
    MatchStatementCase: i[40],
    MatchUnaryPattern: i[6],
    MatchWildcardPattern: i[1],
    MemberExpression: i[38],
    MetaProperty: ['meta', 'property'],
    MethodDefinition: i[42],
    MixedTypeAnnotation: i[1],
    ModuleExpression: i[10],
    NeverTypeAnnotation: i[1],
    NewExpression: i[9],
    NGChainedExpression: i[43],
    NGEmptyExpression: i[1],
    NGMicrosyntax: i[10],
    NGMicrosyntaxAs: ['key', 'alias'],
    NGMicrosyntaxExpression: ['expression', 'alias'],
    NGMicrosyntaxKey: i[1],
    NGMicrosyntaxKeyedExpression: ['key', 'expression'],
    NGMicrosyntaxLet: i[32],
    NGPipeExpression: ['left', 'right', 'arguments'],
    NGRoot: i[37],
    NullableTypeAnnotation: i[23],
    NullLiteral: i[1],
    NullLiteralTypeAnnotation: i[1],
    NumberLiteralTypeAnnotation: i[1],
    NumberTypeAnnotation: i[1],
    NumericLiteral: i[1],
    ...
    ObjectTypeSpreadProperty: i[6],
    OpaqueType: ['id', 'typeParameters', 'supertype', 'impltype', 'lowerBound', 'upperBound'],
    OptionalCallExpression: i[9],
    OptionalIndexedAccessType: i[34],
    OptionalMemberExpression: i[38],
    ParenthesizedExpression: i[3],
    PipelineBareFunction: ['callee'],
    PipelinePrimaryTopicReference: i[1],
    PipelineTopicExpression: i[3],
    Placeholder: i[1],
    PrivateIdentifier: i[1],
    PrivateName: i[21],
    Program: i[7],
    Property: i[32],
    PropertyDefinition: i[14],
    QualifiedTypeIdentifier: i[44],
    QualifiedTypeofIdentifier: i[44],
    RegExpLiteral: i[1],
    RestElement: ['argument', 'typeAnnotation', 'decorators'],
    ReturnStatement: i[6],
    SatisfiesExpression: i[4],
    SequenceExpression: i[43],
    SpreadElement: i[6],
    StaticBlock: i[10],
    StringLiteral: i[1],
    StringLiteralTypeAnnotation: i[1],
    StringTypeAnnotation: i[1],
    Super: i[1],
    SwitchCase: ['test', 'consequent'],
    SwitchStatement: ['discriminant', 'cases'],
    SymbolTypeAnnotation: i[1],
    TaggedTemplateExpression: ['tag', 'typeArguments', 'quasi'],
    TemplateElement: i[1],
    TemplateLiteral: ['quasis', 'expressions'],
    ThisExpression: i[1],
    ThisTypeAnnotation: i[1],
    ThrowStatement: i[6],
    TopicReference: i[1],
    TryStatement: ['block', 'handler', 'finalizer'],
    TSAbstractAccessorProperty: i[45],
    TSAbstractKeyword: i[1],
    TSAbstractMethodDefinition: i[32],
    TSAbstractPropertyDefinition: i[45],
    TSAnyKeyword: i[1],
    TSArrayType: i[2],
    TSAsExpression: i[4],
    TSAsyncKeyword: i[1],
    TSBigIntKeyword: i[1],
    TSBooleanKeyword: i[1],
    TSCallSignatureDeclaration: i[46],
    TSClassImplements: i[47],
    TSConditionalType: i[17],
    TSConstructorType: i[46],
    TSConstructSignatureDeclaration: i[46],
    TSDeclareFunction: i[31],
    TSDeclareKeyword: i[1],
    ...
    TSEnumBody: i[26],
    TSEnumDeclaration: i[19],
    TSEnumMember: ['id', 'initializer'],
    TSExportAssignment: i[3],
    TSExportKeyword: i[1],
    TSExternalModuleReference: i[3],
    TSFunctionType: i[46],
    TSImportEqualsDeclaration: ['id', 'moduleReference'],
    TSImportType: ['options', 'qualifier', 'typeArguments', 'source'],
    TSIndexedAccessType: i[34],
    TSIndexSignature: ['parameters', 'typeAnnotation'],
    TSInferType: i[35],
    TSInstantiationExpression: i[47],
    TSInterfaceBody: i[10],
    TSInterfaceDeclaration: i[22],
    TSInterfaceHeritage: i[47],
    TSIntersectionType: i[36],
    TSIntrinsicKeyword: i[1],
    TSJSDocAllType: i[1],
    TSJSDocNonNullableType: i[23],
    TSJSDocNullableType: i[23],
    TSJSDocUnknownType: i[1],
    TSLiteralType: i[41],
    TSMappedType: ['key', 'constraint', 'nameType', 'typeAnnotation'],
    TSMethodSignature: ['key', 'typeParameters', 'params', 'returnType'],
    TSModuleBlock: i[10],
    TSModuleDeclaration: i[19],
    TSNamedTupleMember: ['label', 'elementType'],
    TSNamespaceExportDeclaration: i[21],
    TSNeverKeyword: i[1],
    TSNonNullExpression: i[3],
    TSNullKeyword: i[1],
    TSNumberKeyword: i[1],
    TSObjectKeyword: i[1],
    TSOptionalType: i[23],
    TSParameterProperty: ['parameter', 'decorators'],
    TSParenthesizedType: i[23],
    TSPrivateKeyword: i[1],
    TSPropertySignature: ['key', 'typeAnnotation'],
    TSProtectedKeyword: i[1],
    TSPublicKeyword: i[1],
    TSQualifiedName: i[5],
    TSReadonlyKeyword: i[1],
    TSRestType: i[23],
    TSSatisfiesExpression: i[4],
    TSStaticKeyword: i[1],
    TSStringKeyword: i[1],
    TSSymbolKeyword: i[1],
    ...
    TSTypeAnnotation: i[23],
    TSTypeAssertion: i[4],
    TSTypeLiteral: i[26],
    TSTypeOperator: i[23],
    TSTypeParameter: ['name', 'constraint', 'default'],
    TSTypeParameterDeclaration: i[48],
    TSTypeParameterInstantiation: i[48],
    TSTypePredicate: i[49],
    TSTypeQuery: ['exprName', 'typeArguments'],
    TSTypeReference: ['typeName', 'typeArguments'],
    TSUndefinedKeyword: i[1],
    TSUnionType: i[36],
    TSUnknownKeyword: i[1],
    TSVoidKeyword: i[1],
    ...
    TypeAlias: i[24],
    TypeAnnotation: i[23],
    TypeCastExpression: i[4],
    TypeofTypeAnnotation: ['argument', 'typeArguments'],
    TypeOperator: i[23],
    TypeParameter: ['bound', 'default', 'variance'],
    TypeParameterDeclaration: i[48],
    TypeParameterInstantiation: i[48],
    TypePredicate: i[49],
    UnaryExpression: i[6],
    UndefinedTypeAnnotation: i[1],
    UnionTypeAnnotation: i[36],
    UnknownTypeAnnotation: i[1],
    UpdateExpression: i[6],
    V8IntrinsicIdentifier: i[1],
    VariableDeclaration: ['declarations'],
    VariableDeclarator: i[27],
    Variance: i[1],
    VoidPattern: i[1],
    VoidTypeAnnotation: i[1],
    WhileStatement: i[25],
...
var ie = Zs,
  eo = w(['Block', 'CommentBlock', 'MultiLine']),
  he = eo,
  to = w([
    'AnyTypeAnnotation',
    'ThisTypeAnnotation',
...
var io = w([
  ...
  ee = w(['ArrayExpression']),
  Ae = w(['ObjectExpression']);
function po(e) {
...
var Hn = w([
  ...
  co = w(['Identifier', 'ThisExpression', 'Super', 'PrivateName', 'PrivateIdentifier']),
  Xe = w(['ObjectTypeAnnotation', 'TSTypeLiteral', 'TSMappedType']),
  kt = w(['FunctionExpression', 'ArrowFunctionExpression']);
function Do(e) {
  return e.type === 'FunctionExpression' || (e.type === 'ArrowFunctionExpression' && e.body.type === 'BlockStatement');
}
function Dn(e) {
  return (
    L(e) && e.callee.type === 'Identifier' && ['async', 'inject', 'fakeAsync', 'waitForAsync'].includes(e.callee.name)
  );
}
...
function mo(e) {
  return (
    e.type === 'Identifier' &&
    (e.name === 'beforeEach' || e.name === 'beforeAll' || e.name === 'afterEach' || e.name === 'afterAll')
  );
}
var Fo = [
  'it',
...
function rn(e, t) {
  ...
  } else if ((n.length === 2 || n.length === 3) && (n[0].type === 'TemplateLiteral' || Q(n[0])) && Eo(e.callee))
    return n[2] && !be(n[2]) ? !1 : (n.length === 2 ? kt(n[1]) : Do(n[1]) && te(n[1]).length <= 1) || Dn(n[1]);
  return !1;
}
var yu = e => t => (t?.type === 'ChainExpression' && (t = t.expression), e(t)),
  L = yu(w(['CallExpression', 'OptionalCallExpression'])),
  R = yu(w(['MemberExpression', 'OptionalMemberExpression']));
function Tr(e, t = 5) {
  return du(e, t) <= t;
}
function du(e, t) {
...
function Yn(e, t) {
  ...
  if (g(e)) return !1;
  let r = n * Ao;
  if (e.type === 'ThisExpression' || (e.type === 'Identifier' && e.name.length <= r) || (lu(e) && !g(e.argument)))
    return !0;
...
function fu(e, t) {
  return (
    ((e.type === 'TemplateLiteral' && Sr(e)) || (e.type === 'TaggedTemplateExpression' && Sr(e.quasi))) &&
    !oe(t, j(e), { backwards: !0 })
  );
}
function mu(e) {
  if (!g(e)) return !1;
...
`),
  ...
  return R(e)
    ? me(e.object, t) && me(e.property, t)
    : (e.type === 'UnaryExpression' && Co.has(e.operator)) || e.type === 'UpdateExpression'
      ? me(e.argument, t)
      : !1;
}
function Pe(e, t = 'es5') {
...
function Qt(e, t) {
  ...
  n.type === 'ImportExpression' || n.type === 'TSImportType'
    ? (e.call(() => t(e, 0), 'source'), n.options && e.call(() => t(e, 1), 'options'))
...
function Br(e, t) {
  let n = [];
  if (
    (e.type === 'ChainExpression' && ((e = e.expression), n.push('expression')),
    e.type === 'ImportExpression' || e.type === 'TSImportType')
  ) {
...
var b = { Leading: 2, Trailing: 4, Dangling: 8, Block: 16, Line: 32, PrettierIgnore: 64, First: 128, Last: 256 },
  Eu = (e, t) => {
    if ((typeof e == 'function' && ((t = e), (e = 0)), e || t))
      return (n, r, u) =>
        !(
          (e & b.Leading && !n.leading) ||
          (e & b.Trailing && !n.trailing) ||
          (e & b.Dangling && (n.leading || n.trailing)) ||
          (e & b.Block && !he(n)) ||
          (e & b.Line && !Mt(n)) ||
          (e & b.First && r !== 0) ||
          (e & b.Last && r !== u.length - 1) ||
          (e & b.PrettierIgnore && !Dt(n)) ||
          (t && !t(n))
        );
  };
function g(e, t, n) {
...
var Fe = w(['TSAsExpression', 'TSSatisfiesExpression', 'AsExpression', 'AsConstExpression', 'SatisfiesExpression']),
  Be = w(['TSUnionType', 'UnionTypeAnnotation']),
  Ot = w(['TSIntersectionType', 'IntersectionTypeAnnotation']),
  Re = w(['TSConditionalType', 'ConditionalTypeAnnotation']),
  bo = e =>
  ...
  Bn = w(['TSTypeAliasDeclaration', 'TypeAlias']);
...
function gu(e, t, n) {
  if (
    ...
    (e.type === 'BigIntLiteral' || e.type === 'Literal') && e.bigint && (t.bigint = e.bigint.toLowerCase()),
    (e.type === 'EmptyStatement' && !Vn({ node: e, parent: n })) ||
      e.type === 'JSXText' ||
  ...
  if (
    ...
    e.openingElement.attributes.some(u => u.type === 'JSXAttribute' && u.name.name === 'jsx')
  )
    for (let { type: u, expression: a } of t.children)
      u === 'JSXExpressionContainer' && a.type === 'TemplateLiteral' && at(a);
  (e.type === 'JSXAttribute' &&
    e.name.name === 'css' &&
    e.value.type === 'JSXExpressionContainer' &&
    e.value.expression.type === 'TemplateLiteral' &&
    at(t.value.expression),
    e.type === 'JSXAttribute' &&
      e.value?.type === 'Literal' &&
      /["']|&quot;|&apos;/u.test(e.value.value) &&
      (t.value.value = z(0, e.value.value, /["']|&quot;|&apos;/gu, '"')));
...
var vo = gu,
  Po = w(['File', 'TemplateElement', 'TSEmptyBodyFunctionExpression', 'ChainExpression']),
  ko = (e, [t]) =>
    ...
    (t?.type === 'Property' && t.shorthand && t.key === e && !Lt(t) && t.value !== t.key),
  wo = (e, [t]) =>
    !!(
  ...
  vr = (e, [t]) => t?.typeAnnotation === e && bo(t),
  Io = (e, [t, ...n]) => vr(e, [t]) || (t?.typeName === e && vr(t, n));
function No(e, t) {
  return Po(e) || ko(e, t) || wo(e, t)
    ? !1
    : e.type === 'EmptyStatement'
      ? Vn({ node: e, parent: t[0] })
      : !(Io(e, t) || (e.type === 'TSTypeAnnotation' && t[0].type === 'TSPropertySignature'));
}
var jo = No;
function Mo(e) {
...
function tr({ comment: e, precedingNode: t, enclosingNode: n, followingNode: r, text: u }) {
  ...
  if (t === n.consequent && r === n.alternate) {
    ...
    if (j(e) < a || n.alternate.type === 'BlockStatement')
      return t.type === 'BlockStatement' || (er(e, u) && !ce(u, j(t), j(e))) ? (W(t, e), !0) : (le(n, e), !0);
  }
  return r.type === 'BlockStatement'
    ? (Ye(r, e), !0)
    : r.type === 'IfStatement'
      ? (vn(r.consequent, e), !0)
      : n.consequent === r
...
function nr({ comment: e, precedingNode: t, enclosingNode: n, followingNode: r, text: u }) {
  return n?.type !== 'WhileStatement' || !r
    ? !1
    : ge(u, N(e)) === ')'
      ? (W(t, e), !0)
...
function hu({ comment: e, precedingNode: t, enclosingNode: n, followingNode: r }) {
  return (n?.type !== 'TryStatement' && n?.type !== 'CatchClause') || !r
    ? !1
    : n.type === 'CatchClause' && t
      ? (W(t, e), !0)
      : r.type === 'BlockStatement'
        ? (Ye(r, e), !0)
        : r.type === 'TryStatement'
...
function $o({ comment: e, enclosingNode: t, followingNode: n, options: r }) {
  return !r.experimentalTernaries || !(t?.type === 'ConditionalExpression' || Re(t))
    ? !1
    : n?.type === 'ConditionalExpression' || Re(n)
      ? (le(t, e), !0)
      : !1;
}
function xu({ comment: e, precedingNode: t, enclosingNode: n, followingNode: r, text: u, options: a }) {
  let s = t && !ce(u, N(t), j(e));
  return (!t || !s) && (n?.type === 'ConditionalExpression' || Re(n)) && r
    ? a.experimentalTernaries && n.alternate === r && !(he(e) && !ce(a.originalText, j(e), N(e)))
      ? (le(n, e), !0)
      : (V(r, e), !0)
    : !1;
}
...
function Su({ comment: e, precedingNode: t, enclosingNode: n, text: r }) {
  return (n &&
    ...
    n.key === t &&
    ge(r, N(t)) !== ':') ||
    (t?.type === 'Decorator' && Vo(n) && (Mt(e) || e.placement === 'ownLine'))
    ? (W(t, e), !0)
    : !1;
}
...
function zo({ comment: e, enclosingNode: t, text: n }) {
  return ge(n, N(e)) !== ')'
    ? !1
    : t && ((Iu(t) && te(t).length === 0) || (yt(t) && ye(t).length === 0))
      ? (le(t, e), !0)
      : (t?.type === 'MethodDefinition' || t?.type === 'TSAbstractMethodDefinition') && te(t.value).length === 0
        ? (le(t.value, e), !0)
        : !1;
}
function Yo({ comment: e, precedingNode: t, enclosingNode: n, followingNode: r, text: u }) {
  return (t?.type === 'ComponentTypeParameter' &&
    (n?.type === 'DeclareComponent' || n?.type === 'ComponentTypeAnnotation') &&
...
function Bu({ comment: e, precedingNode: t, enclosingNode: n, followingNode: r, text: u }) {
  return (t?.type === 'FunctionTypeParam' && n?.type === 'FunctionTypeAnnotation' && r?.type !== 'FunctionTypeParam') ||
    ((t?.type === 'Identifier' ||
    ...
    : !he(e) &&
        r?.type === 'BlockStatement' &&
        bu(n) &&
        (n.type === 'MethodDefinition' ? n.value.body : n.body) === r &&
        ft(u, N(e)) === j(r)
      ? (Ye(r, e), !0)
      : !1;
}
...
function Zo({ comment: e, precedingNode: t, enclosingNode: n, followingNode: r }) {
  return Be(n)
    ? (Dt(e) && ((r.prettierIgnore = !0), (e.unignore = !0)), t ? (W(t, e), !0) : !1)
    : (Be(r) && Dt(e) && ((r.types[0].prettierIgnore = !0), (e.unignore = !0)), !1);
}
function ei({ comment: e, precedingNode: t, enclosingNode: n, followingNode: r }) {
  return n && n.type === 'MatchOrPattern'
    ? (Dt(e) && ((r.prettierIgnore = !0), (e.unignore = !0)), t ? (W(t, e), !0) : !1)
    : (r && r.type === 'MatchOrPattern' && Dt(e) && ((r.types[0].prettierIgnore = !0), (e.unignore = !0)), !1);
}
...
function ur({ comment: e, enclosingNode: t, ast: n, isLastComment: r }) {
  return n?.body?.length === 0
    ? (r ? le(n, e) : V(n, e), !0)
    : t?.type === 'Program' && t.body.length === 0 && !_(t.directives)
      ? (r ? le(t, e) : V(t, e), !0)
      : !1;
}
...
function Pu({ comment: e, precedingNode: t, enclosingNode: n, text: r }) {
  ...
  let u = t?.type === 'ImportSpecifier' && n?.type === 'ImportDeclaration',
    a = t?.type === 'ExportSpecifier' && n?.type === 'ExportNamedDeclaration';
  return (u || a) && oe(r, N(e)) ? (W(t, e), !0) : !1;
}
function ri({ comment: e, enclosingNode: t }) {
  return t?.type === 'AssignmentPattern' ? (V(t, e), !0) : !1;
}
var ui = w(['VariableDeclarator', 'AssignmentExpression', 'TypeAlias', 'TSTypeAliasDeclaration']),
  ai = w([
    'ObjectExpression',
    'ArrayExpression',
    'TemplateLiteral',
...
function oi({ comment: e, enclosingNode: t, precedingNode: n, followingNode: r, text: u }) {
  return !r &&
    (t?.type === 'TSMethodSignature' || t?.type === 'TSDeclareFunction' || t?.type === 'TSAbstractMethodDefinition') &&
    (!n || n !== t.returnType) &&
    ge(u, N(e)) === ';'
    ? (W(t, e), !0)
    : !1;
...
function ii({ comment: e, enclosingNode: t, followingNode: n }) {
  return !t || t.type !== 'SwitchCase' || t.test || !n || n !== t.consequent[0]
    ? !1
    : (n.type === 'BlockStatement' && Mt(e) ? Ye(n, e) : le(t, e), !0);
}
function pi({ comment: e, precedingNode: t, enclosingNode: n, followingNode: r }) {
  return Be(t) && (((n.type === 'TSArrayType' || n.type === 'ArrayTypeAnnotation') && !r) || Ot(n))
    ? (W(O(0, t.types, -1), e), !0)
    : !1;
}
...
function Di({ enclosingNode: e, followingNode: t, comment: n }) {
  if (e && (e.type === 'TSPropertySignature' || e.type === 'ObjectTypeProperty') && (Be(t) || Ot(t)))
    return (V(t, n), !0);
}
...
function yi({ comment: e, enclosingNode: t, followingNode: n, precedingNode: r }) {
  return t &&
    ...
    t.returnType === r &&
    (r.type === 'TSTypeAnnotation' || r.type === 'TypeAnnotation')
    ? (V(n, e), !0)
    : !1;
}
var Iu = w([
  ...
  di = { endOfLine: Ro, ownLine: Xo, remaining: _o },
  fi = di;
function mi(e, { parser: t }) {
  if (t === 'flow' || t === 'hermes' || t === 'babel-flow')
    return ((e = z(0, e, /[\s(]/gu, '')), e === '' || e === '/*' || e === '/*::');
}
var Fi = mi,
  Ei = w([
    'ClassDeclaration',
...
function Ai(e) {
  ...
  if (
    (t === 'types' && Be(n)) ||
    (t === 'argument' && n.type === 'JSXSpreadAttribute') ||
    (t === 'expression' && n.type === 'JSXSpreadChild') ||
    (t === 'superClass' && (n.type === 'ClassDeclaration' || n.type === 'ClassExpression')) ||
    ((t === 'id' || t === 'typeParameters') && Ei(n)) ||
    (t === 'patterns' && n.type === 'MatchOrPattern')
  )
    return !0;
  let { node: r } = e;
...
var gi = Ai,
  ...
  Le = 'label',
  Oe = 'break-parent',
  Nu = new Set([mt, Ze, et, tt, fe, We, Se, nt, rt, Ue, pe, Le, Oe]);
function Ci(e) {
...
var $e = Ci,
  hi = e => new Intl.ListFormat('en-US', { type: 'disjunction' }).format(e);
function xi(e) {
      ...
      switch (s) {
        ...
        case fe:
          if (r && a.expandedStates)
            for (let o = a.expandedStates.length, p = o - 1; p >= 0; --p) u.push(a.expandedStates[p]);
...
function c(e, t = {}) {
  return (
    Ni(t.expandedStates),
    { type: fe, id: t.id, contents: e, break: !!t.shouldBreak, expandedStates: t.expandedStates }
  );
}
function Ke(e, t) {
...
function Gi(e, t, n) {
  ...
  let r;
  return (
    typeof t == 'number' ? (t < 0 ? (r = $i) : (r = { type: 2, width: t })) : (r = { type: 3, string: t }),
    Xu(e, r, n)
  );
}
function Vi(e, t) {
...
var se = Symbol('MODE_BREAK'),
  Te = Symbol('MODE_FLAT'),
  kn = Symbol('DOC_FILL_PRINTED_LENGTH');
  ...
  for (; n >= 0; ) {
    ...
    switch (d) {
      ...
      case fe: {
        ...
        let f = D.break ? se : y,
          F = D.expandedStates && f === se ? O(0, D.expandedStates, -1) : D.contents;
        p.push({ mode: f, doc: F });
        break;
      }
      case Se: {
...
`,
      ...
      case fe:
        switch (h) {
          ...
          case se: {
            p = !1;
            let I = { indent: S, mode: Te, doc: T.contents },
              J = r - a,
              H = l.length > 0;
            if (!T.break && Gt(I, s, J, H, n)) s.push(I);
              ...
              if (T.break) {
                ...
                for (let U = 1; U < T.expandedStates.length + 1; U++)
                  if (U >= T.expandedStates.length) {
                    s.push({ indent: S, mode: se, doc: q });
                    break;
                  } else {
                    let $ = T.expandedStates[U],
                      ae = { indent: S, mode: Te, doc: $ };
                    if (Gt(ae, s, J, H, n)) {
                      s.push(ae);
                      break;
                    }
      ...
      case We: {
        ...
        let U = H[J + 0],
          $ = H[J + 1],
          ae = { indent: S, mode: Te, doc: U },
          xe = { indent: S, mode: se, doc: U },
          P = Gt(ae, [], I, l.length > 0, n, !0);
        if (q === 1) {
          P ? s.push(ae) : s.push(xe);
          break;
        }
        let G = { indent: S, mode: Te, doc: $ },
          K = { indent: S, mode: se, doc: $ };
        if (q === 2) {
          P ? s.push(G, ae) : s.push(K, xe);
          break;
        }
        let we = H[J + 2],
          Ve = { indent: S, mode: h, doc: { ...T, [kn]: J + 2 } },
          Rt = Gt({ indent: S, mode: Te, doc: [U, $, we] }, [], I, l.length > 0, n, !0);
      ...
      case pe:
        switch (h) {
          ...
          case se:
            ...
            T.literal
              ? ((o += u), (a = 0), S.root && (S.root.value && (o += S.root.value), (a = S.root.length)))
              : (v(), (o += u + S.value), (a = S.length));
            break;
        }
        break;
      case Le:
  ...
  function v() {
    ...
    (S && (D.push(S), (f += S.length)),
      (o = ''),
      (a -= h),
      y.length > 0 && (d.push(...y.map(T => Math.min(T, f))), (y.length = 0)));
  }
}
function Hi(e, t, n = 0) {
  let r = 0;
...
`)
      ...
      let f = s[p],
        F = r[u][p],
        B = ce(t.originalText, N(l), j(r.quasis[p + 1]));
      if (!B) {
...
function Zi(e, t, n) {
  let r = n('quasi'),
    { node: u } = e,
    a = '',
    s = He(u.quasi, b.Leading)[0];
  return (
    s && (ce(t.originalText, N(u.typeArguments ?? u.tag), j(s)) ? (a = m) : (a = ' ')),
    Jt(r.label && { tagged: !0, ...r.label }, [n('tag'), n('typeArguments'), a, ve, r])
  );
}
function ep(e, t, n) {
  let { node: r } = e,
    u = r.quasis[0].value.raw.trim().split(/\s*\|\s*/u);
  if (u.length > 1 || u.some(a => a.length > 0)) {
    t.__inJestEach = !0;
    let a = e.map(n, 'expressions');
    t.__inJestEach = !1;
    let s = a.map(D => '${' + _u(D, { ...t, printWidth: Number.POSITIVE_INFINITY, endOfLine: 'lf' }).formatted + '}'),
    ...
    for (let D = 1; D < r.quasis.length; D++) {
      ...
      (d.cells.push(f),
        f.includes(`
`) && (d.hasLineBreak = !0),
        r.quasis[D].value.raw.includes(`
`) && o.push({ hasLineBreak: !1, cells: [] }));
    }
    let p = Math.max(u.length, ...o.map(D => D.cells.length)),
      l = Array.from({ length: p }).fill(0),
      y = [{ cells: u }, ...o.filter(D => D.cells.length > 0)];
    for (let { cells: D } of y.filter(d => !d.hasLineBreak))
      for (let [d, f] of D.entries()) l[d] = Math.max(l[d], it(f));
    return [
      ve,
      '`',
      E([
        ...
        M(
          ...
          y.map(D =>
            M(
              ' | ',
              D.cells.map((d, f) => (D.hasLineBreak ? d : d + ' '.repeat(l[f] - it(d)))),
            ),
          ),
        ),
      ]),
...
function np({ node: e, parent: t }) {
  ...
  return (
    ...
    ((t.tag.object.type === 'Identifier' && n.test(t.tag.object.name)) ||
...
var wn = [
  ...
  (e, t) =>
    e.type === 'CallExpression' && e.callee.type === 'Identifier' && e.callee.name === 'Component' && t === 'arguments',
  (e, t) => e.type === 'Decorator' && t === 'expression',
];
function rp(e) {
  let t = r => r.type === 'TemplateLiteral',
    n = (r, u) => _e(r) && !r.computed && r.key.type === 'Identifier' && r.key.name === 'styles' && u === 'value';
  return e.match(t, (r, u) => ee(r) && u === 'elements', n, ...wn) || e.match(t, n, ...wn);
}
function up(e) {
  return e.match(
    t => t.type === 'TemplateLiteral',
    (t, n) => _e(t) && !t.computed && t.key.type === 'Identifier' && t.key.name === 'template' && n === 'value',
    ...wn,
  );
}
function mn(e, t) {
...
function op(e, t) {
  ...
  let n = 0,
    r = Ft(or(e), u =>
      typeof u != 'string' || !u.includes('@prettier-placeholder')
        ? u
        : u.split(/@prettier-placeholder-(\d+)-id/u).map((a, s) => (s % 2 === 0 ? ze(a) : (n++, t[a]))),
    );
...
function ip(e) {
  return (
    e.match(
      void 0,
      (t, n) =>
        n === 'quasi' && t.type === 'TaggedTemplateExpression' && Gn(t.tag, ['css', 'css.global', 'css.resolve']),
    ) ||
    e.match(
      void 0,
      (t, n) => n === 'expression' && t.type === 'JSXExpressionContainer',
      (t, n) =>
        n === 'children' &&
        t.type === 'JSXElement' &&
        ...
        t.openingElement.attributes.some(
          r => r.type === 'JSXAttribute' && r.name.type === 'JSXIdentifier' && r.name.name === 'jsx',
        ),
    )
  );
}
    ...
    case 'CallExpression':
      return (
        ...
        (t.callee.type === 'MemberExpression' &&
          ((t.callee.object.type === 'MemberExpression' && (Vt(t.callee.object.object) || Ir(t.callee.object))) ||
            (t.callee.object.type === 'CallExpression' && Vt(t.callee.object.callee))))
      );
    case 'Identifier':
      return t.name === 'css';
    default:
...
`),
      f = d.length,
      F = a[o],
      B = f > 2 && d[0].trim() === '' && d[1].trim() === '',
      C = f > 2 && d[f - 1].trim() === '' && d[f - 2].trim() === '',
      v = d.every(h => /^\s*(?:#[^\n\r]*)?$/u.test(h));
    if (!y && /#[^\n\r]*$/u.test(d[f - 1])) return null;
    let S = null;
    (v ? (S = yp(d)) : (S = await e(D, { parser: 'graphql' })),
      S ? ((S = Uu(S, !1)), !l && B && s.push(''), s.push(S), !y && C && s.push('')) : !l && !y && B && s.push(''),
      F && s.push(F));
  }
  return ['`', E([A, M(A, s)]), A, '`'];
}
...
async function Vu(e, t, n, r, u) {
  let { node: a } = r,
    s = Fn;
  Fn = (Fn + 1) >>> 0;
  let o = v => `PRETTIER_HTML_PLACEHOLDER_${v}_${s}_IN_JS`,
    p = a.quasis.map((v, S, h) => (S === h.length - 1 ? v.value.cooked : v.value.cooked + o(S))).join(''),
    l = ir(r, n),
    y = new RegExp(o('(\\d+)'), 'gu'),
    D = 0,
    d = await t(p, {
    ...
    F = /^\s/u.test(p) ? ' ' : '',
    B = /\s$/u.test(p) ? ' ' : '',
    C = u.htmlWhitespaceSensitivity === 'ignore' ? A : F && B ? x : null;
...
function fp(e) {
  return (
    ...
    e.match(
      t => t.type === 'TemplateLiteral',
      (t, n) =>
        t.type === 'TaggedTemplateExpression' && t.tag.type === 'Identifier' && t.tag.name === 'html' && n === 'quasi',
    )
  );
}
var mp = Vu.bind(void 0, 'html'),
  Fp = Vu.bind(void 0, 'angular');
async function Ep(e, t, n) {
  let { node: r } = n,
    u = z(0, r.quasis[0].value.raw, /((?:\\\\)*)\\`/gu, (p, l) => '\\'.repeat(l.length / 2) + '`'),
    a = Ap(u),
    s = a !== '';
...
var Cp = [
  ...
  { test: up, print: Fp },
  { test: gp, print: Ep },
].map(({ test: e, print: t }) => ({ test: e, print: xp(t) }));
function hp(e) {
  let { node: t } = e;
...
function Jp(e) {
  ...
  let n = wp(e),
    { pragmas: r, comments: u } = Np(n);
  return { shebang: t, text: e, pragmas: r, comments: u };
}
function qp(e) {
  let { shebang: t, text: n, pragmas: r, comments: u } = Jp(e),
    a = Ip(n),
    s = jp({ pragmas: { [Mp]: '', ...r }, comments: u.trimStart() });
  return (
    (t
      ? `${t}
`
...
`);
  return [
    ...
    M(
      A,
      t.map((n, r) => (r === 0 ? n.trimEnd() : ' ' + (r < t.length - 1 ? n.trim() : n.trimStart()))),
    ),
    '*/',
  ];
}
function In(e, t) {
  ...
  if (n.type === 'Identifier') {
    if (
      (n.extra?.parenthesized && /^PRETTIER_HTML_PLACEHOLDER_\d+_\d+_IN_JS$/u.test(n.name)) ||
      (r === 'left' && ((n.name === 'async' && !u.await) || n.name === 'let') && u.type === 'ForOfStatement')
    )
      return !0;
    if (n.name === 'let') {
    ...
    if (r === 'object' && n.name === 'let' && u.type === 'MemberExpression' && u.computed && !u.optional) {
      let a = e.findAncestor(
          o => o.type === 'ExpressionStatement' || o.type === 'ForStatement' || o.type === 'ForInStatement',
        ),
        s = a
  ...
  switch (u.type) {
    ...
    case 'ClassExpression':
      if (
        ...
        (n.type === 'ArrowFunctionExpression' ||
          ...
          (n.type === 'ClassExpression' && _(n.decorators)))
      )
        return !0;
      break;
    ...
    case 'Decorator':
      ...
      break;
    case 'TypeAnnotation':
      if (e.match(void 0, void 0, (a, s) => s === 'returnType' && a.type === 'ArrowFunctionExpression') && Vp(n))
        return !0;
      break;
    case 'BinaryExpression':
      if (r === 'left' && (u.operator === 'in' || u.operator === 'instanceof') && n.type === 'UnaryExpression')
        return !0;
      break;
    case 'VariableDeclarator':
      if (
        ...
        e.match(
          void 0,
          void 0,
          (a, s) => s === 'declarations' && a.type === 'VariableDeclaration',
          (a, s) => s === 'left' && a.type === 'ForInStatement',
        )
      )
        return !0;
      break;
  ...
  switch (n.type) {
    case 'UpdateExpression':
      if (u.type === 'UnaryExpression')
        return n.prefix && ((n.operator === '++' && u.operator === '+') || (n.operator === '--' && u.operator === '-'));
    ...
    case 'TSFunctionType':
      if (
        e.match(
          a => a.type === 'TSFunctionType',
          (a, s) => s === 'typeAnnotation' && a.type === 'TSTypeAnnotation',
          (a, s) => s === 'returnType' && a.type === 'ArrowFunctionExpression',
        )
      )
        return !0;
    ...
    case 'ConditionalTypeAnnotation':
      ...
      if (r === 'extendsType' && u.type === 'TSConditionalType') {
        ...
        if (
          (a.type === 'TSTypePredicate' && a.typeAnnotation && (a = a.typeAnnotation.typeAnnotation),
          a.type === 'TSInferType' && a.typeParameter.constraint)
        )
          return !0;
      }
    case 'TSUnionType':
    ...
    case 'TSInferType':
      if (n.type === 'TSInferType') {
        ...
        if (
          r === 'types' &&
          (u.type === 'TSUnionType' || u.type === 'TSIntersectionType') &&
          n.typeParameter.type === 'TSTypeParameter' &&
          n.typeParameter.constraint
        )
          return !0;
      }
    case 'TSTypeOperator':
      return (
        u.type === 'TSArrayType' ||
        u.type === 'TSOptionalType' ||
        u.type === 'TSRestType' ||
        (r === 'objectType' && u.type === 'TSIndexedAccessType') ||
        u.type === 'TSTypeOperator' ||
        (u.type === 'TSTypeAnnotation' && e.grandparent.type.startsWith('TSJSDoc'))
      );
    case 'TSTypeQuery':
      return (
        (r === 'objectType' && u.type === 'TSIndexedAccessType') || (r === 'elementType' && u.type === 'TSArrayType')
      );
    case 'TypeOperator':
      return (
        u.type === 'ArrayTypeAnnotation' ||
        u.type === 'NullableTypeAnnotation' ||
        (r === 'objectType' && (u.type === 'IndexedAccessType' || u.type === 'OptionalIndexedAccessType')) ||
        u.type === 'TypeOperator'
      );
    case 'TypeofTypeAnnotation':
      return (
        (r === 'objectType' && (u.type === 'IndexedAccessType' || u.type === 'OptionalIndexedAccessType')) ||
        (r === 'elementType' && u.type === 'ArrayTypeAnnotation')
      );
    ...
    case 'UnionTypeAnnotation':
      return (
        u.type === 'TypeOperator' ||
        u.type === 'KeyofTypeAnnotation' ||
        u.type === 'ArrayTypeAnnotation' ||
        u.type === 'NullableTypeAnnotation' ||
        u.type === 'IntersectionTypeAnnotation' ||
        u.type === 'UnionTypeAnnotation' ||
        (r === 'objectType' && (u.type === 'IndexedAccessType' || u.type === 'OptionalIndexedAccessType'))
      );
    ...
    case 'FunctionTypeAnnotation': {
      ...
      if (
        e.match(
          void 0,
          (s, o) => o === 'typeAnnotation' && s.type === 'TypeAnnotation',
          (s, o) => o === 'returnType' && s.type === 'ArrowFunctionExpression',
        ) ||
        e.match(
          void 0,
          (s, o) => o === 'typeAnnotation' && s.type === 'TypePredicate',
          (s, o) => o === 'typeAnnotation' && s.type === 'TypeAnnotation',
          (s, o) => o === 'returnType' && s.type === 'ArrowFunctionExpression',
        )
      )
      ...
      return (
        a.type === 'UnionTypeAnnotation' ||
        a.type === 'IntersectionTypeAnnotation' ||
        a.type === 'ArrayTypeAnnotation' ||
        (r === 'objectType' && (a.type === 'IndexedAccessType' || a.type === 'OptionalIndexedAccessType')) ||
        (r === 'checkType' && u.type === 'ConditionalTypeAnnotation') ||
        (r === 'extendsType' &&
          u.type === 'ConditionalTypeAnnotation' &&
          n.returnType?.type === 'InferTypeAnnotation' &&
          n.returnType?.typeParameter.bound) ||
        a.type === 'NullableTypeAnnotation' ||
        (u.type === 'FunctionTypeParam' &&
          u.name === null &&
          te(n).some(s => s.typeAnnotation?.type === 'NullableTypeAnnotation'))
      );
    }
    ...
    case 'AssignmentExpression':
      return !(
        ((r === 'init' || r === 'update') && u.type === 'ForStatement') ||
        (r === 'expression' && n.left.type !== 'ObjectPattern' && u.type === 'ExpressionStatement') ||
        (r === 'key' && u.type === 'TSPropertySignature') ||
        u.type === 'AssignmentExpression' ||
        (r === 'expressions' &&
          u.type === 'SequenceExpression' &&
          e.match(void 0, void 0, (a, s) => (s === 'init' || s === 'update') && a.type === 'ForStatement')) ||
        (r === 'value' &&
          u.type === 'Property' &&
          e.match(void 0, void 0, (a, s) => s === 'properties' && a.type === 'ObjectPattern')) ||
        u.type === 'NGChainedExpression' ||
        (r === 'node' && u.type === 'JsExpressionRoot')
      );
    case 'ConditionalExpression':
      switch (u.type) {
        case 'TaggedTemplateExpression':
    ...
    case 'BindExpression':
      return (
        (r === 'callee' && (u.type === 'BindExpression' || u.type === 'NewExpression')) || (r === 'object' && R(u))
      );
    case 'NGPipeExpression':
      return !(
        u.type === 'NGRoot' ||
        u.type === 'NGMicrosyntaxExpression' ||
        (u.type === 'ObjectProperty' && !n.extra?.parenthesized) ||
        ee(u) ||
        (r === 'arguments' && L(u)) ||
        (r === 'right' && u.type === 'NGPipeExpression') ||
        (r === 'property' && u.type === 'MemberExpression') ||
        u.type === 'AssignmentExpression'
      );
    case 'JSXFragment':
    case 'JSXElement':
      return (
        r === 'callee' ||
        (r === 'left' && u.type === 'BinaryExpression' && u.operator === '<') ||
        (!ee(u) &&
          ...
          u.type !== 'TypeCastExpression' &&
          u.type !== 'VariableDeclarator' &&
          u.type !== 'YieldExpression' &&
          u.type !== 'MatchExpressionCase')
      );
    case 'TSInstantiationExpression':
      return r === 'object' && R(u);
    case 'MatchOrPattern':
...
function zu(e, t) {
  ...
  return n.type === 'FunctionExpression' || n.type === 'ClassExpression'
    ? r.type === 'ExportDefaultDeclaration' || !In(e, t)
    : !Kn(n) || (r.type !== 'ExportDefaultDeclaration' && In(e, t))
      ? !1
      : e.call(() => zu(e, t), ...pu(n));
}
function Hp(e) {
  return !!(
    e.match(
      void 0,
      (t, n) => n === 'expression' && t.type === 'ChainExpression',
      (t, n) => n === 'tag' && t.type === 'TaggedTemplateExpression',
    ) ||
    e.match(
    ...
    e.match(
      t => t.type === 'OptionalCallExpression' || t.type === 'OptionalMemberExpression',
      (t, n) => n === 'expression' && t.type === 'TSNonNullExpression',
      (t, n) => n === 'tag' && t.type === 'TaggedTemplateExpression',
    ) ||
    e.match(
      void 0,
    ...
    e.match(
      ...
      (t, n) =>
        ...
        (n === 'callee' && (t.type === 'CallExpression' || t.type === 'NewExpression')),
    ) ||
    e.match(
      t => t.type === 'OptionalMemberExpression' || t.type === 'OptionalCallExpression',
      (t, n) => n === 'expression' && t.type === 'TSNonNullExpression',
      (t, n) => (n === 'object' && t.type === 'MemberExpression') || (n === 'callee' && t.type === 'CallExpression'),
    ) ||
    (e.match(
      ...
      (e.match(
        ...
        void 0,
        (t, n) =>
          (n === 'callee' && ((t.type === 'CallExpression' && !t.optional) || t.type === 'NewExpression')) ||
          (n === 'object' && t.type === 'MemberExpression' && !t.optional),
      ) ||
        e.match(
          void 0,
          void 0,
          (t, n) => n === 'expression' && t.type === 'TSNonNullExpression',
          (t, n) =>
            (n === 'object' && t.type === 'MemberExpression') || (n === 'callee' && t.type === 'CallExpression'),
        ))) ||
    e.match(
      t => t.type === 'CallExpression' || t.type === 'MemberExpression',
      (t, n) => n === 'expression' && t.type === 'TSNonNullExpression',
...
function Nn(e) {
  return e.type === 'Identifier'
    ? !0
    : R(e)
      ? !e.computed && !e.optional && e.property.type === 'Identifier' && Nn(e.object)
      : !1;
}
function zp(e) {
...
function el(e, t) {
  let n = e.node,
    r = [pr(e, t)],
    { printer: u, originalText: a, locStart: s, locEnd: o } = t;
...
function tl(e, t, n) {
  let r = e.node,
    ...
    p = a.isBlockComment?.(r);
  if ((n?.hasLineSuffix && !n?.isBlock) || oe(s, o(r), { backwards: !0 })) {
    let l = Qp(s, o(r));
    return { doc: wr([A, l ? A : '', u]), isBlock: p, hasLineSuffix: !0 };
  }
  return !p || n?.hasLineSuffix
    ? { doc: [wr([' ', u]), Me], isBlock: p, hasLineSuffix: !0 }
    : { doc: [' ', u], isBlock: p, hasLineSuffix: !1 };
}
function X(e, t, n = {}) {
  let { node: r } = e;
  if (!_(r?.comments)) return '';
  let { indent: u = !1, marker: a, filter: s = Zp } = n,
    o = [];
  if (
    (e.each(({ node: l }) => {
...
function ut(e, t, n, r, u) {
  let a = e.node,
    s = te(a),
    o = u && a.typeParameters ? n('typeParameters') : '';
  ...
  if (
    (So(e, (f, F) => {
      ...
      (B && a.rest && D.push('...'),
        D.push(n()),
        !B && (D.push(','), l || y ? D.push(' ') : ke(s[F], t) ? D.push(A, A) : D.push(x)));
    }),
    r && !rl(e))
  ) {
  ...
  return y && d
    ...
    : l
      ...
      : (Du(p) ||
            ...
            (p.type === 'FunctionTypeAnnotation' && p.returnType === a)) &&
          s.length === 1 &&
          s[0].name === null &&
          a.this !== s[0] &&
          s[0].typeAnnotation &&
          a.typeParameters === null &&
          zn(s[0].typeAnnotation) &&
          !a.rest
        ? t.arrowParens === 'always' || a.type === 'HookTypeAnnotation'
          ? ['(', ...D, ')']
          : D
        : [o, '(', E([m, ...D]), k(!To(a) && Pe(t, 'all') && e.root.type !== 'NGRoot' ? ',' : ''), m, ')'];
}
function Yu(e) {
  if (!e) return !1;
  let t = te(e);
  ...
  return (
    ...
    (n.type === 'ObjectPattern' ||
      ...
      (n.type === 'Identifier' &&
        ...
        Xe(n.typeAnnotation.typeAnnotation)) ||
      (n.type === 'FunctionTypeParam' && Xe(n.typeAnnotation) && n !== e.rest) ||
      (n.type === 'AssignmentPattern' &&
        (n.left.type === 'ObjectPattern' || n.left.type === 'ArrayPattern') &&
        (n.right.type === 'Identifier' ||
          (Ae(n.right) && n.right.properties.length === 0) ||
          (ee(n.right) && n.right.elements.length === 0))))
  );
}
function nl(e) {
  let t;
...
function rl(e) {
  return e.match(
    ...
    (t, n) =>
      (t.type === 'VariableDeclarator' && n === 'init') ||
      (t.type === 'ExportDefaultDeclaration' && n === 'declaration') ||
      (t.type === 'TSExportAssignment' && n === 'expression') ||
...
function ue(e) {
  ...
  return !t.optional || (t.type === 'Identifier' && t === e.parent.key)
    ? ''
    : L(t) || (R(t) && t.computed) || t.type === 'OptionalIndexedAccessType'
      ? '?.'
      : '?';
}
function Qu(e) {
...
var dt = ll,
  cl = 0;
function Zu(e, t, n) {
  let { node: r, parent: u, grandparent: a, key: s } = e,
    o =
      s !== 'body' &&
      (u.type === 'IfStatement' ||
        u.type === 'WhileStatement' ||
        u.type === 'SwitchStatement' ||
        u.type === 'DoWhileStatement'),
    p = r.operator === '|>' && e.root.extra?.__isUsingHackPipeline,
    l = jn(e, t, n, !1, o);
  if (o) return l;
  if (p) return c(l);
  if ((s === 'callee' && (L(u) || u.type === 'NewExpression')) || u.type === 'UnaryExpression' || (R(u) && !u.computed))
    return c([E([m, ...l]), m]);
  let y =
      u.type === 'ReturnStatement' ||
      u.type === 'ThrowStatement' ||
      (u.type === 'JSXExpressionContainer' && a.type === 'JSXAttribute') ||
      (r.operator !== '|' && u.type === 'JsExpressionRoot') ||
      (r.type !== 'NGPipeExpression' &&
        ((u.type === 'NGRoot' && t.parser === '__ng_binding') ||
          (u.type === 'NGMicrosyntaxExpression' && a.type === 'NGMicrosyntax' && a.body.length === 1))) ||
      (r === u.body && u.type === 'ArrowFunctionExpression') ||
      (r !== u.body && u.type === 'ForStatement') ||
      (u.type === 'ConditionalExpression' &&
    ...
    D =
      ...
      u.type === 'TSAbstractPropertyDefinition' ||
      u.type === 'ClassPrivateProperty' ||
      _e(u),
    d = Ne(r.left) && Qn(r.operator, r.left.operator);
  if (y || (Nt(r) && !d) || (!Nt(r) && D)) return c(l);
  if (l.length === 0) return '';
  let f = Y(r.right),
    F = l.findIndex(T => typeof T != 'string' && !Array.isArray(T) && T.type === fe),
    B = l.slice(0, F === -1 ? 1 : F + 1),
    C = l.slice(B.length, f ? -1 : void 0),
    v = Symbol('logicalChain-' + ++cl),
    S = c([...B, E(C)], { id: v });
  if (!f) return S;
  let h = O(0, l, -1);
...
function jn(e, t, n, r, u) {
  ...
  let o = Nt(a),
    p = a.right.type === 'ChainExpression' ? a.right.expression : a.right,
    l = (a.operator === '|>' || a.type === 'NGPipeExpression' || Dl(e, t)) && !Ee(t.originalText, p),
    y = !g(p, b.Leading, Cu) && Ee(t.originalText, p),
    D = a.type === 'NGPipeExpression' ? '|' : a.operator,
    d =
      a.type === 'NGPipeExpression' && a.arguments.length > 0
        ? c(
            E([
              m,
              ': ',
  ...
  let { parent: F } = e,
    B = g(a.left, b.Trailing | b.Line);
  if (
    ((B ||
      (!(u && a.type === 'LogicalExpression') &&
        F.type !== a.type &&
        a.left.type !== a.type &&
        a.right.type !== a.type)) &&
      (f = c(f, { shouldBreak: B })),
    t.experimentalOperatorPosition === 'start' ? s.push(o || y ? ' ' : '', f) : s.push(l ? '' : ' ', f),
    r && g(a))
  ) {
    let C = or(de(e, s, t));
...
function Nt(e) {
  return e.type !== 'LogicalExpression'
    ? !1
    : !!((Ae(e.right) && e.right.properties.length > 0) || (ee(e.right) && e.right.elements.length > 0) || Y(e.right));
}
...
function Dl(e, t) {
  return (
    ...
    Lr(e.node) &&
    !e.hasAncestor(n => !Lr(n) && n.type !== 'JsExpressionRoot')
  );
}
function yl(e) {
...
function ea(e, t, n) {
  let { node: r } = e,
    { parent: u } = e,
    a =
      u.type !== 'TypeParameterInstantiation' &&
      (!Re(u) || !t.experimentalTernaries) &&
      u.type !== 'TSTypeParameterInstantiation' &&
      u.type !== 'GenericTypeAnnotation' &&
      u.type !== 'TSTypeReference' &&
      u.type !== 'TSTypeAssertion' &&
      u.type !== 'TupleTypeAnnotation' &&
      u.type !== 'TSTupleType' &&
      !(u.type === 'FunctionTypeParam' && !u.name && e.grandparent.this !== u) &&
      !((Bn(u) || u.type === 'VariableDeclarator') && Ee(t.originalText, r)) &&
      !(Bn(u) && g(u.id, b.Trailing | b.Line)),
    s = ta(r),
    o = e.map(() => {
      let f = n();
  ...
  let y = a && !Ee(t.originalText, r),
    D = [k([y ? x : '', '| ']), M([x, '| '], o)];
  if (Ge(e, t)) return [p, c([E(D), m]), l];
  let d = [p, c(D)];
  return (u.type === 'TupleTypeAnnotation' || u.type === 'TSTupleType') &&
    u[u.type === 'TupleTypeAnnotation' && u.types ? 'types' : 'elementTypes'].length > 1
    ? [c([E([k(['(', m]), d]), m, k(')')]), l]
    : [c(a ? E(d) : d), l];
}
var dl = w(['VoidTypeAnnotation', 'TSVoidKeyword', 'NullLiteralTypeAnnotation', 'TSNullKeyword']),
  fl = w(['ObjectTypeAnnotation', 'TSTypeLiteral', 'GenericTypeAnnotation', 'TSTypeReference']);
function ta(e) {
  let { types: t } = e;
...
var na = e =>
  e.match(
    ...
    (t, n) =>
      (n === 'returnType' || n === 'typeAnnotation') && (t.type === 'TSFunctionType' || t.type === 'TSConstructorType'),
  )
    ? '=>'
    : e.match(
          t => t.type === 'TSTypeAnnotation',
        ...
        e.match(
          ...
          (t, n) => n === 'typeAnnotation' && t.type === 'Identifier',
          (t, n) => n === 'id' && t.type === 'DeclareFunction',
        ) ||
        e.match(
          t => t.type === 'TypeAnnotation',
          (t, n) => n === 'typeAnnotation' && t.type === 'Identifier',
          (t, n) => n === 'id' && t.type === 'DeclareHook',
        ) ||
        e.match(
          t => t.type === 'TypeAnnotation',
          (t, n) => n === 'bound' && t.type === 'TypeParameter' && t.usesExtendsBound,
        )
      ? ''
      : ':';
function ra(e, t, n) {
...
function lr(e, t, n) {
  let { node: r } = e,
    ...
    s = ']',
    o =
      r.type === 'TupleTypeAnnotation' && r.types
        ? 'types'
        : r.type === 'TSTupleType' || r.type === 'TupleTypeAnnotation'
          ? 'elementTypes'
          : 'elements',
    p = r[o];
  if (p.length === 0) u.push(El(e, t, a, s));
    ...
    let l = O(0, p, -1),
      y = l?.type !== 'RestElement' && !r.inexact,
      D = l === null,
      d = Symbol('array'),
      f =
        !t.__inJestEach &&
      ...
      F = ua(r, t),
      B = y ? (D ? ',' : Pe(t) ? (F ? k(',', '', { groupId: d }) : k(',')) : '') : '';
    u.push(
      c([a, E([m, F ? gl(e, t, n, B) : [Al(e, t, n, o, r.inexact), B], X(e, t)]), m, s], { shouldBreak: f, id: d }),
    );
  }
...
function ua(e, t) {
  return (
    ...
    e.elements.every(
      n =>
        n &&
        (be(n) || (lu(n) && !g(n.argument))) &&
        !g(n, b.Trailing | b.Line, r => !oe(t.originalText, j(r), { backwards: !0 })),
    )
  );
}
...
function Cl(e, t, n) {
  ...
  if (xl(u)) {
    ...
    return re(d)
      ? [Me, Ke([['(', c(d, { shouldBreak: !0 }), ', ', ...D, ')'], l()])]
      : Ke([['(', d, ', ', ...D, ')'], ['(', c(d, { shouldBreak: !0 }), ', ', ...D, ')'], l()]);
  }
  if (hl(u, o, t)) {
    let D = o.slice(0, -1);
    if (D.some(re)) return l();
    ...
    return re(d)
      ? [Me, Ke([['(', ...D, c(d, { shouldBreak: !0 }), ')'], l()])]
      : Ke([['(', ...D, d, ')'], ['(', ...D, c(d, { shouldBreak: !0 }), ')'], l()]);
  }
  let y = ['(', E([m, ...o]), k(p), m, ')'];
...
function vt(e, t = !1) {
  return (
    (Ae(e) && (e.properties.length > 0 || g(e))) ||
    (ee(e) && (e.elements.length > 0 || g(e))) ||
    (e.type === 'TSTypeAssertion' && vt(e.expression)) ||
    (Fe(e) && vt(e.expression)) ||
    e.type === 'FunctionExpression' ||
    (e.type === 'ArrowFunctionExpression' &&
      ...
      (e.body.type === 'BlockStatement' ||
        (e.body.type === 'ArrowFunctionExpression' && vt(e.body, !0)) ||
        Ae(e.body) ||
        ee(e.body) ||
...
function hl(e, t, n) {
  ...
  return (
    ...
    vt(r) &&
    (!u || u.type !== r.type) &&
    (e.length !== 2 || u.type !== 'ArrowFunctionExpression' || !ee(r)) &&
    !(e.length > 1 && ua(r, n))
  );
}
function xl(e) {
  ...
  let [t, n] = e;
  return t.type === 'ModuleExpression' && bl(n)
    ? !0
    : !g(t) &&
...
function sa(e) {
  ...
  if (Fe(e) || e.type === 'TypeCastExpression') {
    ...
    if (
      ...
      t.type === 'TSArrayType' && ((t = t.elementType), t.type === 'TSArrayType' && (t = t.elementType)),
...
function bl(e) {
  ...
  return _e(t)
    ? !t.computed &&
        ((t.key.type === 'Identifier' && t.key.name === 'type') || (Q(t.key) && t.key.value === 'type')) &&
        Q(t.value) &&
...
function Pl(e) {
  ...
  for (let r of n) {
    if (!((R(r) && r.object === t) || (r.type === 'TSNonNullExpression' && r.expression === t)))
      return r.type === 'NewExpression' && r.callee === t;
    t = r;
  }
  return !1;
}
function kl(e, t, n) {
  let r = n('object'),
    u = ia(e, t, n),
    { node: a } = e,
    s = e.findAncestor(l => !(R(l) || l.type === 'TSNonNullExpression')),
    o = e.findAncestor(l => !(l.type === 'ChainExpression' || l.type === 'TSNonNullExpression')),
    p =
      s.type === 'BindExpression' ||
      (s.type === 'AssignmentExpression' && s.left.type !== 'Identifier') ||
      Pl(e) ||
      a.computed ||
      (a.object.type === 'Identifier' && a.property.type === 'Identifier' && !R(o)) ||
      ((o.type === 'AssignmentExpression' || o.type === 'VariableDeclarator') &&
        (vl(a.object) || r.label?.memberChain));
...
function pa(e, t, n) {
  ...
  let r = (e.parent.type === 'ChainExpression' ? e.grandparent : e.parent).type === 'ExpressionStatement',
    u = [];
  function a(P) {
  ...
  function s() {
    ...
    if (L(P) && (ot(P.callee) || L(P.callee))) {
      ...
      (u.unshift({
        node: P,
        hasTrailingEmptyLine: G,
        printed: [de(e, [ue(e), n('typeArguments'), Mn(e, t, n)], t), G ? A : ''],
      }),
        e.call(s, 'callee'));
    } else
      ot(P)
        ? (u.unshift({ node: P, needsParens: Ge(e, t), printed: de(e, R(P) ? ia(e, t, n) : oa(e, t, n), t) }),
          e.call(s, 'object'))
        : P.type === 'TSNonNullExpression'
          ? (u.unshift({ node: P, printed: de(e, '!', t) }), e.call(s, 'expression'))
          : u.unshift({ node: P, printed: n() });
  }
  let { node: o } = e;
  ...
  for (
    ...
    (u[y].node.type === 'TSNonNullExpression' ||
      L(u[y].node) ||
      (R(u[y].node) && u[y].node.computed && be(u[y].node.property)));
    ++y
  )
    l.push(u[y]);
  ...
  for (; y < u.length; ++y) {
    ...
    ((L(u[y].node) || u[y].node.type === 'ImportExpression') && (D = !0),
      l.push(u[y]),
      g(u[y].node, b.Trailing) && (p.push(l), (l = []), (D = !1)));
  }
  l.length > 0 && p.push(l);
  function d(P) {
  ...
  let S = p.map(C),
    ...
    I = p.flat(),
    J =
      I.slice(1, -1).some(P => g(P.node, b.Leading)) ||
      I.slice(0, -1).some(P => g(P.node, b.Trailing)) ||
      (p[T] && g(p[T][0].node, b.Leading));
  if (p.length <= T && !J && !p.some(P => O(0, P, -1).hasTrailingEmptyLine)) return Fu(e) ? h : c(h);
  let H = O(0, p[B ? 1 : 0], -1).node,
    q = !L(H) && a(H),
    U = [C(p[0]), B ? p.slice(1, 2).map(C) : '', q ? A : '', v(p.slice(B ? 2 : 1))],
    $ = u.map(({ node: P }) => P).filter(L);
  function ae() {
    let P = O(0, O(0, p, -1), -1).node,
      G = O(0, S, -1);
    return L(P) && re(G) && $.slice(0, -1).some(K => K.arguments.some(kt));
  }
  let xe;
  return (
    J || ($.length > 2 && $.some(P => !P.arguments.every(G => me(G)))) || S.slice(0, -1).some(re) || ae()
      ? (xe = c(U))
      : (xe = [re(h) || q ? Me : '', Ke([h, U])]),
    Jt({ memberChain: !0 }, xe)
  );
...
function tn(e, t, n) {
  let { node: r } = e,
    u = r.type === 'NewExpression',
    a = ue(e),
    s = ye(r),
    o = r.type !== 'TSImportType' && r.typeArguments ? n('typeArguments') : '',
    p = s.length === 1 && fu(s[0], t.originalText);
  ...
  if (
    ...
    !u &&
    ot(r.callee) &&
    !e.call(() => Ge(e, t), 'callee', ...(r.callee.type === 'ChainExpression' ? ['expression'] : []))
  )
    return wl(e, t, n);
...
function Nl(e) {
  ...
  if (
    !(
      ...
      (t.type === 'CallExpression' && !t.optional && Gn(t.callee, Il))
    )
  )
    return !1;
  let n = ye(t);
...
function Ol(e, t, n, r, u) {
  ...
  let o = !Kt(s);
  if (e.match(Kt, la, y => !o || (y.type !== 'ExpressionStatement' && y.type !== 'VariableDeclaration')))
    return o
      ? s.type === 'ArrowFunctionExpression' && s.body.type === 'ArrowFunctionExpression'
        ? 'chain-tail-arrow-chain'
        : 'chain-tail'
      : 'chain';
  if ((!o && Kt(s.right)) || Ee(t.originalText, s)) return 'break-after-operator';
  if (
    a.type === 'ImportAttribute' ||
    (s.type === 'CallExpression' && s.callee.name === 'require') ||
    t.parser === 'json5' ||
    t.parser === 'jsonc' ||
    t.parser === 'json'
  )
...
function ql(e) {
  if (la(e)) {
    ...
    return (
      ...
      t.properties.some(n => _e(n) && (!n.shorthand || n.value?.type === 'AssignmentPattern'))
    );
  }
  return !1;
}
...
function Rr(e, t) {
  return t.parser === 'json' || t.parser === 'jsonc' || !Q(e.key) || ct(ie(e.key), t).slice(1, -1) !== e.key.value
    ? !1
    : !!(
        (pl(e.key.value) &&
          !(
            (t.parser === 'babel-ts' && e.type === 'ClassProperty') ||
            ((t.parser === 'typescript' || t.parser === 'oxc-ts') && e.type === 'PropertyDefinition')
          )) ||
        (ya(e.key.value) &&
...
function Vl(e, t) {
  ...
  return (
    (n.type === 'Identifier' ||
      (be(n) &&
        ya(dt(ie(n))) &&
        String(n.value) === dt(ie(n)) &&
        !(t.parser === 'typescript' || t.parser === 'babel-ts' || t.parser === 'oxc-ts'))) &&
    (t.parser === 'json' || t.parser === 'jsonc' || (t.quoteProps === 'consistent' && Ht.get(e.parent)))
  );
}
function Xt(e, t, n) {
  let { node: r } = e;
  ...
  return Rr(r, t) && (t.quoteProps === 'as-needed' || (t.quoteProps === 'consistent' && !Ht.get(u)))
    ? e.call(() => de(e, /^\d/u.test(a.value) ? dt(a.value) : a.value, t), 'key')
    : n('key');
}
function An(e, t, n) {
  let { node: r } = e;
...
var Kl = ({ node: e, key: t, parent: n }) =>
  ...
  (n.type === 'ObjectMethod' ||
    ...
    n.type === 'TSDeclareMethod' ||
    (n.type === 'Property' && Lt(n)));
function da(e, t, n, r) {
  ...
  let s = [De(e), u.async ? 'async ' : '', `function${u.generator ? '*' : ''} `, u.id ? n('id') : ''],
    o = ut(e, t, n, a),
    p = pn(e, n),
    l = Et(u, p);
  return (
    s.push(n('typeParameters'), c([l ? c(o) : o, p]), u.body ? ' ' : '', n('body')),
    t.semi && (u.declare || !u.body) && s.push(';'),
    s
  );
}
function Ln(e, t, n) {
  let { node: r } = e,
    ...
    s = [];
  return (
    !u || u === 'init' || u === 'method' || u === 'constructor' ? a.async && s.push('async ') : s.push(u, ' '),
    a.generator && s.push('*'),
    s.push(Xt(e, t, n), r.optional ? '?' : '', r === a ? cr(e, t, n) : n('value')),
    s
  );
}
function cr(e, t, n) {
  let { node: r } = e,
    ...
    s = ul(r),
    o = Et(r, a),
    p = [n('typeParameters'), c([s ? c(u, { shouldBreak: !0 }) : o ? c(u) : u, a])];
    ...
    (Ql(t, r.argument)
      ...
      : (Ne(r.argument) ||
          (t.experimentalTernaries &&
            r.argument.type === 'ConditionalExpression' &&
            (r.argument.consequent.type === 'ConditionalExpression' ||
              r.argument.alternate.type === 'ConditionalExpression'))) &&
        (o = c([k('('), E([m, o]), m, k(')')])),
      u.push(' ', o));
  }
  let a = g(r, b.Dangling),
    s = t.semi && a && g(r, b.Last | b.Line);
...
function Zl(e, t) {
  ...
  return !!(
    ...
    ((r === 'body' &&
      (u.type === 'Program' ||
        u.type === 'BlockStatement' ||
        u.type === 'StaticBlock' ||
        u.type === 'TSModuleBlock')) ||
      (r === 'consequent' && u.type === 'SwitchCase')) &&
...
function uc(e, t, n) {
  ...
  let u = r.type === 'JSXElement' ? n('openingElement') : n('openingFragment'),
    a = r.type === 'JSXElement' ? n('closingElement') : n('closingFragment');
  if (
    r.children.length === 1 &&
    r.children[0].type === 'JSXExpressionContainer' &&
    (r.children[0].expression.type === 'TemplateLiteral' ||
      r.children[0].expression.type === 'TaggedTemplateExpression')
  )
    return [u, ...e.map(n, 'children'), a];
  r.children = r.children.map(h => (Cc(h) ? { type: 'JSXText', value: ' ', raw: ' ' } : h));
  let s = r.children.some(Y),
    o = r.children.filter(h => h.type === 'JSXExpressionContainer').length > 1,
    p = r.type === 'JSXElement' && r.openingElement.attributes.length > 1,
    l = re(u) || s || p || o,
    y = e.parent.rootMarker === 'mdx',
    D = t.singleQuote ? "{' '}" : '{" "}',
    d = y ? x : k([D, m], ' '),
    f = r.openingElement?.name?.name === 'fbt',
    F = ac(e, t, n, d, f),
    B = r.children.some(h => jt(h));
  for (let h = F.length - 2; h >= 0; h--) {
    let T = F[h] === '' && F[h + 1] === '',
      I = F[h] === A && F[h + 1] === '' && F[h + 2] === A,
      J = (F[h] === m || F[h] === A) && F[h + 1] === '' && F[h + 2] === d,
      H = F[h] === d && F[h + 1] === '' && (F[h + 2] === m || F[h + 2] === A),
      q = F[h] === d && F[h + 1] === '' && F[h + 2] === d,
      U = (F[h] === m && F[h + 1] === '' && F[h + 2] === A) || (F[h] === A && F[h + 1] === '' && F[h + 2] === m);
  ...
  if (
    (t.cursorNode?.type === 'JSXText' && r.children.includes(t.cursorNode)
      ? (v = [$t, v, $t])
      : t.nodeBeforeCursor?.type === 'JSXText' && r.children.includes(t.nodeBeforeCursor)
        ? (v = [$t, v])
        : t.nodeAfterCursor?.type === 'JSXText' && r.children.includes(t.nodeAfterCursor) && (v = [v, $t]),
    y)
  )
    return v;
  let S = c([u, E([A, v]), A, a]);
...
function _r(e, t, n, r) {
  return e
    ? ''
    : (n.type === 'JSXElement' && !n.closingElement) || (r?.type === 'JSXElement' && !r.closingElement)
      ? t.length === 1
        ? m
        : A
      : m;
...
function ic(e) {
  return (
    e.match(
      void 0,
      (t, n) => n === 'body' && t.type === 'ArrowFunctionExpression',
      (t, n) => n === 'arguments' && L(t),
    ) &&
    (e.match(void 0, void 0, void 0, (t, n) => n === 'expression' && t.type === 'JSXExpressionContainer') ||
      e.match(
        void 0,
        void 0,
        void 0,
...
function pc(e, t, n) {
  ...
  if (r.value) {
    ...
    if (Q(r.value)) {
      let s = ie(r.value),
        o = z(0, z(0, s.slice(1, -1), '&apos;', "'"), '&quot;', '"'),
        p = ru(o, t.jsxSingleQuote);
      ((o = p === '"' ? z(0, o, '"', '&quot;') : z(0, o, "'", '&apos;')),
        (a = e.call(() => de(e, ze(p + o + p), t), 'value')));
    } else a = n('value');
    u.push('=', a);
  }
  return u;
    ...
    u = (a, s) =>
      ...
      (!g(a) &&
        (ee(a) ||
          ...
          (a.type === 'AwaitExpression' && (u(a.argument, a) || a.argument.type === 'JSXElement')) ||
          L(a) ||
          (a.type === 'ChainExpression' && L(a.expression)) ||
          a.type === 'FunctionExpression' ||
          a.type === 'TemplateLiteral' ||
          a.type === 'TaggedTemplateExpression' ||
          a.type === 'DoExpression' ||
          (Y(s) && (a.type === 'ConditionalExpression' || Ne(a)))));
  return u(r.expression, e.parent) ? c(['{', n('expression'), ve, '}']) : c(['{', E([m, n('expression')]), m, ve, '}']);
}
function cc(e, t, n) {
  let { node: r } = e,
    u = g(r.name) || g(r.typeArguments);
  if (r.selfClosing && r.attributes.length === 0 && !u) return ['<', n('name'), n('typeArguments'), ' />'];
  if (
    r.attributes?.length === 1 &&
    Q(r.attributes[0].value) &&
    !r.attributes[0].value.value.includes(`
`) &&
    !u &&
    !g(r.attributes[0])
  )
    return c(['<', n('name'), n('typeArguments'), ' ', ...e.map(n, 'attributes'), r.selfClosing ? ' />' : '>']);
  let a = r.attributes?.some(
      o =>
        Q(o.value) &&
        o.value.value.includes(`
`),
    ),
    s = t.singleAttributePerLine && r.attributes.length > 1 ? A : x;
  return c(['<', n('name'), n('typeArguments'), E(e.map(() => [s, n()], 'attributes')), ...Dc(r, t, u)], {
    shouldBreak: a,
  });
}
function Dc(e, t, n) {
...
function yc(e, t, n) {
  ...
  return (
    (e.attributes.length === 0 && !n) ||
    ((t.bracketSameLine || t.jsxBracketSameLine) && (!n || e.attributes.length > 0) && !r)
  );
}
function dc(e, t, n) {
  let { node: r } = e,
    ...
    a = n('name');
  return (
    g(r.name, b.Leading | b.Line) ? u.push(E([A, a]), A) : g(r.name, b.Leading | b.Block) ? u.push(' ', a) : u.push(a),
    u.push('>'),
    u
  );
}
  ...
  if (r.type.startsWith('NG'))
    switch (r.type) {
      ...
      case 'NGMicrosyntaxKeyedExpression': {
        let { index: u, parent: a } = e,
          s =
            Ur(e) ||
            Sc(e) ||
            (((u === 1 && (r.key.name === 'then' || r.key.name === 'else' || r.key.name === 'as')) ||
              (u === 2 &&
                ((r.key.name === 'else' &&
                  a.body[u - 1].type === 'NGMicrosyntaxKeyedExpression' &&
                  a.body[u - 1].key.name === 'then') ||
                  r.key.name === 'track'))) &&
...
function Ta(e) {
  return (
    Cn.has(e) || Cn.set(e, e.type === 'ConditionalExpression' && !ne(e, t => t.type === 'ObjectExpression')),
    Cn.get(e)
  );
}
...
function wc(e, t, n, r = {}) {
  let u = [],
    ...
    s = [],
    o = !1,
    p = !r.expandLastArg && e.node.body.type === 'ArrowFunctionExpression',
    l;
  (function v() {
    let { node: S } = e,
      h = Ic(e, t, n, r);
    ...
    (p &&
      (o || (o = (S.returnType && te(S).length > 0) || S.typeParameters || te(S).some(T => T.type !== 'Identifier'))),
      !p || S.body.type !== 'ArrowFunctionExpression' ? ((a = n('body', r)), (l = S.body)) : e.call(v, 'body'));
  })();
  let y = !Ee(t.originalText, l) && (kc(l) || Nc(l, a, t) || (!o && Ta(l))),
    D = e.key === 'callee' && yt(e.parent),
    d = Symbol('arrow-chain'),
    f = jc(e, r, { signatureDocs: u, shouldBreak: o }),
    F = !1,
    B = !1,
    C = !1;
  return (
    p &&
      ...
      ((B = !0),
      (C = !g(e.node, b.Leading & b.Line)),
      (F = r.assignmentLayout === 'chain-tail-arrow-chain' || (D && !y))),
    (a = Mc(e, t, r, { bodyDoc: a, bodyComments: s, functionBody: l, shouldPutBodyOnSameLine: y })),
    c([
      c(B ? E([C ? m : '', f]) : f, { shouldBreak: F, id: d }),
      ' =>',
      p ? It(a, { groupId: d }) : c(a),
      p && D ? k(m, '', { groupId: d }) : '',
    ])
  );
}
function Ic(e, t, n, r) {
  ...
  if ((u.async && a.push('async '), fa(e, t))) a.push(n(['params', 0]));
    ...
    let o = r.expandLastArg || r.expandFirstArg,
      p = pn(e, n);
    if (o) {
...
function Nc(e, t, n) {
  return (
    ...
    Y(e) ||
    (t.label?.hug !== !1 && (t.label?.embed || fu(e, n.originalText)))
  );
}
function jc(e, t, { signatureDocs: n, shouldBreak: r }) {
  if (n.length === 1) return n[0];
  let { parent: u, key: a } = e;
  return (a !== 'callee' && yt(u)) || Ne(u)
    ? c([n[0], ' =>', E([x, M([' =>', x], n.slice(1))])], { shouldBreak: r })
    : (a === 'callee' && yt(u)) || t.assignmentLayout
      ? c(M([' =>', x], n), { shouldBreak: r })
      : c(E(M([' =>', x], n)), { shouldBreak: r });
}
function Mc(e, t, n, { bodyDoc: r, bodyComments: u, functionBody: a, shouldPutBodyOnSameLine: s }) {
  let { node: o, parent: p } = e,
    l = n.expandLastArg && Pe(t, 'all') ? k(',') : '',
    y = (n.expandLastArg || p.type === 'JSXExpressionContainer') && !g(o) ? m : '';
...
function On(e, t, n, r) {
  let { node: u } = e,
    a = [],
    s = Jc(0, u[r], o => o.type !== 'EmptyStatement');
  return (
    e.each(({ node: o }) => {
...
function Sa(e, t, n) {
  ...
  if ((u.type === 'StaticBlock' && s.push('static '), s.push('{'), r)) s.push(E([A, r]), A);
    ...
    a.type === 'ArrowFunctionExpression' ||
      ...
      a.type === 'ObjectMethod' ||
      a.type === 'ClassMethod' ||
      a.type === 'ClassPrivateMethod' ||
      a.type === 'ForStatement' ||
      a.type === 'WhileStatement' ||
      a.type === 'DoWhileStatement' ||
      a.type === 'DoExpression' ||
      a.type === 'ModuleExpression' ||
      (a.type === 'CatchClause' && !o.finalizer) ||
      a.type === 'TSModuleDeclaration' ||
      a.type === 'MatchStatementCase' ||
      u.type === 'StaticBlock' ||
      s.push(A);
  }
  return (s.push('}'), s);
...
function qc(e, t, n) {
  let { node: r } = e,
    u = _(r.directives),
    a = r.body.some(p => p.type !== 'EmptyStatement'),
    s = g(r, b.Dangling);
  if (!u && !a && !s) return '';
  let o = [];
  return (
    u && (o.push(On(e, t, n, 'directives')), (a || s) && (o.push(A), ke(O(0, r.directives, -1), t) && o.push(A))),
    a && o.push(On(e, t, n, 'body')),
    s && o.push(X(e, t)),
    o
  );
}
...
function dr(e, t, n) {
  let { node: r } = e,
    ...
    D;
  if (
    (_c(e, ({ node: d, next: f, isLast: F }) => {
      if ((D ?? (D = d), u.push(n()), s && a)) {
        let { parent: B } = e;
        B.inexact || !F ? u.push(',') : Pe(t) && u.push(k(','));
      }
      (!s && (Wc({ node: d, next: f }, t) || va({ node: d, next: f }, t)) && u.push(';'),
        F || (u.push(o), ke(d, t) && u.push(A)));
    }),
    p && u.push(X(e, t)),
    r.type === 'ObjectTypeAnnotation' && r.inexact)
  ) {
    let d;
    (g(r, b.Dangling)
      ? (d = [g(r, b.Line) || oe(t.originalText, N(O(0, He(r), -1))) ? A : x, '...'])
      : (d = [D ? x : '', '...']),
      u.push(d));
  }
  if (s) {
    let d = p || (t.objectWrap === 'preserve' && D && ce(t.originalText, j(r), j(D))),
      f;
    if (u.length === 0) f = l + y;
    else {
    ...
    return e.match(
      void 0,
      (F, B) => B === 'typeAnnotation',
      (F, B) => B === 'typeAnnotation',
      Bt,
    ) || e.match(void 0, (F, B) => F.type === 'FunctionTypeParam' && B === 'typeAnnotation', Bt)
      ? f
      : c(f, { shouldBreak: d });
  }
...
function ba(e) {
  ...
  if (t.type === 'ObjectTypeAnnotation') {
    ...
    return (
      n === 'body' && (r.type === 'InterfaceDeclaration' || r.type === 'DeclareInterface' || r.type === 'DeclareClass')
    );
  }
...
function _c(e, t) {
  ...
  if (n.type === 'ObjectTypeAnnotation') {
    let r = ['properties', 'indexers', 'callProperties', 'internalSlots']
      .flatMap(u => e.map(({ node: a, index: s }) => ({ node: a, loc: j(a), selector: [u, s] }), u))
      .sort((u, a) => u.loc - a.loc);
    for (let [u, { node: a, selector: s }] of r.entries())
      e.call(() => t({ node: a, next: r[u + 1]?.node, isLast: u === r.length - 1 }), ...s);
  }
}
function Ie(e, t) {
  let { parent: n } = e;
  return e.callParent(ba)
    ? t.semi || n.type === 'ObjectTypeAnnotation'
      ? ';'
      : ''
    : n.type === 'TSTypeLiteral'
      ? e.isLast
        ? t.semi
          ? k(';')
          : ''
        : t.semi || va({ node: e.node, next: e.next }, t)
          ? ';'
          : k('', ';')
      : '';
}
...
var $c = Rc('heritageGroup'),
  Gc = w(['TSInterfaceDeclaration', 'DeclareInterface', 'InterfaceDeclaration', 'InterfaceTypeAnnotation']);
function fr(e, t, n) {
  let { node: r } = e,
    u = Gc(r),
    a = [De(e), sn(e), u ? 'interface' : 'class'],
    s = ka(e),
    o = [],
    p = [];
  ...
  if (r.superClass) {
    let y = [Hc(e, t, n), n(r.superTypeArguments ? 'superTypeArguments' : 'superTypeParameters')],
  ...
  let l;
  return (
    s ? ((l = $c(r)), a.push(c([...o, E(p)], { id: l }))) : a.push(...o, ...p),
    !u && s && Vc(r.body) ? a.push(k(A, ' ', { groupId: l })) : a.push(' '),
    a.push(n('body')),
    a
  );
}
function Vc(e) {
  return e.type === 'ObjectTypeAnnotation'
    ? ['properties', 'indexers', 'callProperties', 'internalSlots'].some(t => _(e[t]))
    : _(e.body);
}
function Pa(e) {
...
function Kc(e) {
  ...
  if (t.superClass)
    return e.parent.type === 'AssignmentExpression'
      ? !1
      : !(t.superTypeArguments ?? t.superTypeParameters) && R(t.superClass);
  let n = t.extends?.[0] ?? t.mixins?.[0] ?? t.implements?.[0];
  return n
    ? (n.type === 'InterfaceExtends' && n.id.type === 'QualifiedTypeIdentifier' && !n.typeParameters) ||
        ((n.type === 'TSClassImplements' || n.type === 'TSInterfaceHeritage') && R(n.expression) && !n.typeArguments)
    : !1;
}
var hn = new WeakMap();
function ka(e) {
...
function wa(e, t, n) {
  let { node: r } = e,
    u = [];
  return (
    _(r.decorators) && u.push(Ca(e, t, n)),
    u.push(on(r)),
...
function Ia(e, t, n) {
  ...
  (_(r.decorators) && u.push(Ca(e, t, n)),
    ...
    (r.type === 'ClassAccessorProperty' || r.type === 'AccessorProperty' || r.type === 'TSAbstractAccessorProperty') &&
      u.push('accessor '),
    u.push(Xt(e, t, n), ue(e), Qu(e), Z(e, n)));
...
var ln = aD,
  ...
  sD = w(['EnumBooleanBody', 'EnumNumberBody', 'EnumBigIntBody', 'EnumStringBody', 'EnumSymbolBody']);
function mr(e, t, n) {
  let { node: r, parent: u } = e,
    a = sD(r),
    s = r.type === 'TSEnumBody' || a,
    o = ja(r),
    p = a && r.hasUnknownMembers,
    l = s ? 'members' : o ? 'attributes' : 'properties',
    y = r[l],
    D =
      s ||
      (r.type === 'ObjectPattern' &&
        ...
        u.type !== 'AssignmentPattern' &&
        u.type !== 'CatchClause' &&
        r.properties.some(C => C.value && (C.value.type === 'ObjectPattern' || C.value.type === 'ArrayPattern'))) ||
      (r.type !== 'ObjectPattern' && t.objectWrap === 'preserve' && y.length > 0 && oD(r, y[0], t)),
    d = [],
    f = e.map(({ node: C }) => {
      let v = [...d, c(n())];
  ...
  let F = !(p || O(0, y, -1)?.type === 'RestElement'),
    B;
  if (f.length === 0) {
  ...
  return e.match(C => C.type === 'ObjectPattern' && !_(C.decorators), Bt) ||
    (Xe(r) &&
      (e.match(
        void 0,
        (C, v) => v === 'typeAnnotation',
        (C, v) => v === 'typeAnnotation',
        Bt,
      ) ||
        e.match(void 0, (C, v) => C.type === 'FunctionTypeParam' && v === 'typeAnnotation', Bt))) ||
    (!D &&
      e.match(
        C => C.type === 'ObjectPattern',
        C => C.type === 'AssignmentExpression' || C.type === 'VariableDeclarator',
      ))
    ? B
    : c(B, { shouldBreak: D });
}
...
function La(e, t, n) {
  let { node: r } = e,
    u = [vc(e, t, n), De(e), 'export', Ma(r) ? ' default' : ''],
    { declaration: a, exported: s } = r;
  return (
    g(r, b.Dangling) && (u.push(' ', X(e, t)), mu(r) && u.push(A)),
    a
      ? u.push(' ', n('declaration'))
      : (u.push(cD(r)),
        r.type === 'ExportAllDeclaration' || r.type === 'DeclareExportAllDeclaration'
          ? (u.push(' *'), s && u.push(' as ', n('exported')))
          : u.push(qa(e, t, n)),
        u.push(Ja(e, t, n), Ra(e, t, n))),
    u.push(lD(r, t)),
    u
  );
}
...
function qa(e, t, n) {
  ...
  if (_(r.specifiers)) {
    ...
    (e.each(() => {
      ...
      s.length > 0 &&
        (a.length > 0 && u.push(', '),
        s.length > 1 || a.length > 0 || r.specifiers.some(o => g(o))
          ? u.push(
              c([
                '{',
                E([t.bracketSpacing ? x : m, M([',', x], s)]),
                k(Pe(t) ? ',' : ''),
                t.bracketSpacing ? x : m,
                '}',
              ]),
            )
          : u.push(['{', t.bracketSpacing ? ' ' : '', ...s, t.bracketSpacing ? ' ' : '', '}'])));
  } else u.push('{}');
  return u;
}
function Xa(e, t) {
  return e.type !== 'ImportDeclaration' || _(e.specifiers) || e.importKind === 'type'
    ? !0
    : ln(t, j(e), j(e.source)).trimEnd().endsWith('from');
}
function DD(e, t) {
...
var yD = e => {
  ...
  return (
    r === 'ImportAttribute' &&
    ((u.type === 'Identifier' && u.name === 'type') || (Q(u) && u.value === 'type')) &&
    Q(a) &&
    !g(n) &&
    !g(u) &&
    !g(a)
...
function dD(e, t, n) {
  let { node: r } = e,
    ...
    D = '';
  return (
    u === 'ExportNamespaceSpecifier' || u === 'ImportNamespaceSpecifier' ? (y = '*') : p && (y = n(s)),
    l && !fD(r) && (D = n(o)),
    [Fr(u === 'ImportSpecifier' ? r.importKind : r.exportKind, !1), y, y && D ? ' as ' : '', D]
  );
}
function fD(e) {
  if (e.type !== 'ImportSpecifier' && e.type !== 'ExportSpecifier') return !1;
  let { local: t, [e.type === 'ImportSpecifier' ? 'imported' : 'exported']: n } = e;
  return t.type !== n.type || !Gs(t, n)
    ? !1
    : Q(t)
      ? t.value === n.value && ie(t) === ie(n)
      : t.type === 'Identifier'
        ? t.name === n.name
        : !1;
}
...
function FD(e, t, n) {
  let { node: r } = e,
    u = r.type === 'ConditionalExpression',
    a = u ? 'alternate' : 'falseType',
    { parent: s } = e,
    o = u ? n('test') : [n('checkType'), ' ', 'extends', ' ', n('extendsType')];
...
function AD(e) {
  ...
  for (let u = 0; !n; u++) {
    ...
    if (
      (a.type === 'ChainExpression' && a.expression === r) ||
      (L(a) && a.callee === r) ||
      (R(a) && a.object === r) ||
      (a.type === 'TSNonNullExpression' && a.expression === r)
    ) {
      r = a;
      continue;
    }
    (a.type === 'NewExpression' && a.callee === r) || (Fe(a) && a.expression === r)
      ? ((n = e.getParentNode(u + 1)), (r = a))
      : (n = a);
  }
...
function gD(e, t, n) {
  let { node: r } = e,
    ...
    s = u ? 'alternate' : 'falseType',
    o = u ? ['test'] : ['checkType', 'extendsType'],
    p = r[a],
    l = r[s],
    y = [],
    D = !1,
    { parent: d } = e,
    f = d.type === r.type && o.some(q => d[q] === r),
    F = d.type === r.type && !f,
    B,
    C,
    v = 0;
  do ((C = B || r), (B = e.getParentNode(v)), v++);
  ...
  if (u && (Y(r[o[0]]) || Y(p) || Y(l) || mD(h))) {
    ...
    let q = $ => (t.useTabs ? E(n($)) : Ce(2, n($))),
      U = [x, '? ', p.type === r.type ? k('', '(') : '', q(a), p.type === r.type ? k('', ')') : '', x, ': ', q(s)];
    y.push(d.type !== r.type || d[s] === r || f ? U : t.useTabs ? Mu(E(U)) : Ce(Math.max(0, t.tabWidth - 2), U));
  }
  let T = q => (d === S ? c(q) : q),
    I = !D && (R(d) || (d.type === 'NGPipeExpression' && d.left === r)) && !d.computed,
    J = AD(e),
    H = T([FD(e, t, n), F ? y : E(y), u && I && !J ? m : '']);
...
function Er(e, t, n, r) {
  ...
  let { node: u } = e,
    a = u.type === 'ConditionalExpression',
    s = Re(u),
    o = a ? 'consequent' : 'trueType',
    p = a ? 'alternate' : 'falseType',
    ...
    J,
    H = 0;
  do ((J = I || u), (I = e.getParentNode(H)), H++);
  ...
  let q = I || f,
    U =
      ...
      (f.type === 'AssignmentExpression' ||
        ...
        f.type === 'Property'),
    $ = (f.type === 'ReturnStatement' || f.type === 'ThrowStatement') && !(v || S),
    ae = a && q.type === 'JSXExpressionContainer' && e.grandparent.type !== 'JSXAttribute',
    xe = TD(e),
    P = CD(u, f),
    G = s && Ge(e, t),
    K = T ? (t.useTabs ? '	' : ' '.repeat(t.tabWidth - 1)) : '',
    we = hD(d, y, D, t) || v || S,
    Ve =
      !h &&
      !F &&
      !s &&
      (ae ? y.type === 'NullLiteral' || (y.type === 'Literal' && y.value === null) : Yn(y, t) && Tr(u.test, 3)),
    Rt = h || C || (s && !F) || (F && a && Tr(u.test, 1)) || Ve,
    Ar = [];
  !v &&
    g(y, b.Dangling) &&
    e.call(() => {
  ...
  (g(u.test, b.Dangling) &&
    ...
    g(u, b.Dangling) && gt.push(X(e, t)));
  let gr = Symbol('test'),
    ss = Symbol('consequent'),
    _t = Symbol('test-and-consequent'),
    os = a
      ? [Tn(n('test')), u.test.type === 'ConditionalExpression' ? Me : '']
      : [
          n('checkType'),
          ' ',
          'extends',
          ' ',
          Re(u.extendsType) || u.extendsType.type === 'TSMappedType' ? n('extendsType') : c(Tn(n('extendsType'))),
        ],
    Cr = c([os, ' ?'], { id: gr }),
    is = n(o),
    Wt = E([v || (ae && (Y(y) || F || h)) ? A : x, Ar, is]),
    ps = Rt ? c([Cr, h ? Wt : k(Wt, c(Wt, { id: ss }), { groupId: gr })], { id: _t }) : [Cr, Wt],
    cn = n(p),
    hr = Ve ? k(cn, Mu(Tn(cn)), { groupId: _t }) : cn,
    Ct = [
      ps,
      gt.length > 0 ? [E([A, gt]), A] : S ? A : Ve ? k(x, ' ', { groupId: _t }) : x,
      ':',
      S ? ' ' : T ? (Rt ? k(K, k(h || Ve ? ' ' : K, ' '), { groupId: _t }) : k(K, ' ')) : ' ',
      S ? hr : c([E(hr), ae && !Ve ? m : '']),
      P && !xe ? m : '',
      we ? Me : '',
    ];
...
function SD(e, t, n, r) {
  ...
  switch (u.type) {
    ...
    case 'ChainExpression':
      return n('expression');
    case 'ParenthesizedExpression':
      return !g(u.expression) && (Ae(u.expression) || ee(u.expression))
        ? ['(', n('expression'), ')']
        : c(['(', E([m, n('expression')]), m, ')']);
    case 'AssignmentExpression':
      return Ml(e, t, n);
    case 'VariableDeclarator':
      return Ll(e, t, n);
    ...
    case 'UnaryExpression': {
      let a = [u.operator];
      return (
        /[a-z]$/u.test(u.operator) && a.push(' '),
        g(u.argument) ? a.push(c(['(', E([m, n('argument')]), m, ')'])) : a.push(n('argument')),
        a
      );
    }
    case 'UpdateExpression':
    ...
    case 'VariableDeclaration': {
      let a = e.map(n, 'declarations'),
        s = e.parent,
        o = s.type === 'ForStatement' || s.type === 'ForInStatement' || s.type === 'ForOfStatement',
        p = u.declarations.some(y => y.init),
        l;
      return (
        a.length === 1 && !g(u.declarations[0]) ? (l = a[0]) : a.length > 0 && (l = E(a[0])),
        c([
          De(e),
          u.kind,
          l ? [' ', l] : '',
          E(a.slice(1).map(y => [',', p && !o ? A : x, y])),
          t.semi && !(o && s.body !== u) ? ';' : '',
        ])
      );
    }
    ...
    case 'IfStatement': {
      let a = Je(u.consequent, n('consequent')),
        s = [c(['if (', c([E([m, n('test')]), m]), ')', a])];
      if (u.alternate) {
        let o = g(u.consequent, b.Trailing | b.Line) || mu(u),
          p = u.consequent.type === 'BlockStatement' && !o;
        (s.push(p ? ' ' : A),
          g(u, b.Dangling) && s.push(X(e, t), o ? A : ' '),
          s.push('else', c(Je(u.alternate, n('alternate'), u.alternate.type === 'IfStatement'))));
      }
      return s;
    }
    case 'ForStatement': {
      ...
      return !u.init && !u.test && !u.update
        ...
        : [
            ...
            c([
              'for (',
              c([E([m, n('init'), ';', x, n('test'), ';', u.update ? [x, n('update')] : k('', x)]), m]),
              ')',
              a,
            ]),
          ];
    ...
    case 'TryStatement':
      return [
        ...
        n('block'),
        u.handler ? [' ', n('handler')] : '',
        u.finalizer ? [' finally ', n('finalizer')] : '',
      ];
    case 'CatchClause':
      if (u.param) {
        let a = g(
            ...
            o =>
              !he(o) ||
              (o.leading && oe(t.originalText, N(o))) ||
              (o.trailing && oe(t.originalText, j(o), { backwards: !0 })),
          ),
          s = n('param');
      ...
      return [
        ...
        u.cases.length > 0
          ? E([
              ...
              M(
                A,
                e.map(({ node: a, isLast: s }) => [n(), !s && ke(a, t) ? A : ''], 'cases'),
              ),
            ])
          : '',
        A,
...
function Wa(e, t, n) {
  let { parent: r, node: u, key: a } = e,
    s = u.type === 'AsConstExpression' ? 'const' : n('typeAnnotation'),
    o = [n('expression'), ' ', bD(u) ? 'satisfies' : 'as', ' ', s];
...
function BD(e, t, n) {
  ...
  let a = vD(e, t, n);
  return (
    r.rendersType ? u.push(c([a, ' ', n('rendersType')])) : u.push(c([a])),
    r.body && u.push(' ', n('body')),
    t.semi && r.type === 'DeclareComponent' && u.push(';'),
    u
  );
}
function vD(e, t, n) {
  ...
  if ((r.rest && (u = [...u, r.rest]), u.length === 0))
    return ['(', X(e, t, { filter: s => ge(t.originalText, N(s)) === ')' }), ')'];
  let a = [];
  return (
    kD(e, (s, o) => {
      let p = o === u.length - 1;
...
function Va(e, t, n) {
  ...
  return (
    r.type === 'FunctionTypeAnnotation'
      ? s.push(jD(e) ? ' => ' : ': ', n('returnType'))
      : s.push(Z(e, n, 'returnType')),
    Et(r, s) && (a = c(a)),
    u.push(a, s),
    [c(u), r.type === 'TSConstructSignatureDeclaration' || r.type === 'TSCallSignatureDeclaration' ? Ie(e, t) : '']
  );
}
function jD(e) {
  let { node: t, parent: n } = e;
...
function za(e, t, n) {
  let r = !1;
  return c(
    e.map(({ isFirst: u, previous: a, node: s, index: o }) => {
      let p = n();
      if (u) return p;
      let l = Xe(s),
        y = Xe(a);
...
function XD(e, t, n) {
  ...
  return c(
    [
      ...
      E([
        t.bracketSpacing ? x : m,
        g(r, b.Dangling) ? c([X(e, t), A]) : '',
        c([
          r.readonly ? [Hr(r.readonly, 'readonly'), ' '] : '',
          '[',
          n('key'),
          ' in ',
          n('constraint'),
  ...
  return [
    ...
    r.cases.length > 0
      ? E([
          ...
          M(
            A,
            e.map(({ node: u, isLast: a }) => [n(), !a && ke(u, t) ? A : ''], 'cases'),
          ),
        ])
      : '',
    A,
...
function _D(e, t, n) {
  let { node: r } = e,
    u = g(r, b.Dangling) ? [' ', X(e, t)] : [],
    a = r.type === 'MatchStatementCase' ? [' ', n('body')] : E([x, n('body'), ',']);
...
function GD(e, t, n) {
  let { node: r } = e,
    { parent: u } = e,
    a =
      u.type !== 'MatchStatementCase' &&
      u.type !== 'MatchExpressionCase' &&
      u.type !== 'MatchArrayPattern' &&
      u.type !== 'MatchObjectPatternProperty' &&
      !Ee(t.originalText, r),
    s = $D(r),
    o = e.map(() => {
      let l = n();
  ...
  return Ge(e, t)
    ? c([E([k([m]), p]), m])
    : u.type === 'MatchArrayPattern' && u.elements.length > 1
      ? c([E([k(['(', m]), p]), m, k(')')])
      : c(a ? E(p) : p);
}
function VD(e, t, n) {
  let { node: r } = e,
    u = [De(e), 'opaque type ', n('id'), n('typeParameters')];
  if ((r.supertype && u.push(': ', n('supertype')), r.lowerBound || r.upperBound)) {
    let a = [];
    (r.lowerBound && a.push(E([x, 'super ', n('lowerBound')])),
      r.upperBound && a.push(E([x, 'extends ', n('upperBound')])),
      u.push(c(a)));
  }
...
function es(e, t, n) {
  let { node: r } = e,
    u = [De(e), 'type ', n('id'), n('typeParameters')],
    a = r.type === 'TSTypeAliasDeclaration' ? 'typeAnnotation' : 'right';
...
function Pt(e, t, n, r) {
  ...
  let a = rn(e.grandparent),
    s = e.match(
      p => !(p[r].length === 1 && Xe(p[r][0])),
      void 0,
      (p, l) => l === 'typeAnnotation',
      p => p.type === 'Identifier',
      ca,
    );
  if (
    u[r].length === 0 ||
    (!s && (a || (u[r].length === 1 && (u[r][0].type === 'NullableTypeAnnotation' || ml(u[r][0])))))
  )
    return ['<', M(', ', e.map(n, r)), HD(e, t), '>'];
...
function ts(e, t, n) {
  let { node: r } = e,
    u = [r.const ? 'const ' : ''],
    a = r.type === 'TSTypeParameter' ? n('name') : r.name;
  if (
    (r.variance && u.push(n('variance')),
    r.in && u.push('in '),
    r.out && u.push('out '),
    u.push(a),
    r.bound && (r.usesExtendsBound && u.push(' extends '), u.push(Z(e, n, 'bound'))),
    r.constraint)
  ) {
...
function ns(e, t) {
  let { node: n } = e;
  return [
    n.type === 'TSTypePredicate' && n.asserts ? 'asserts ' : n.type === 'TypePredicate' && n.kind ? `${n.kind} ` : '',
    t('parameterName'),
    n.typeAnnotation ? [' is ', Z(e, t)] : '',
  ];
}
...
function zD(e, t, n) {
  ...
  switch (r.type) {
    ...
    case 'ObjectTypeProperty': {
      let u = '';
      return (
        r.proto ? (u = 'proto ') : r.static && (u = 'static '),
        [
          u,
          r.kind !== 'init' ? r.kind + ' ' : '',
          r.variance ? n('variance') : '',
    ...
    case 'DeclaredPredicate':
      return [
        ...
        '%checks',
        ...(r.type === 'DeclaredPredicate' ? ['(', n('value'), ')'] : []),
      ];
    case 'AsExpression':
    case 'AsConstExpression':
    case 'SatisfiesExpression':
...
function YD(e, t, n) {
  let { node: r } = e,
    u = r.parameters.length > 1 ? k(Pe(t) ? ',' : '') : '',
    a = c([E([m, M([', ', m], e.map(n, 'parameters'))]), u, m]);
  return [
    e.key === 'body' && e.parent.type === 'ClassBody' && r.static ? 'static ' : '',
    r.readonly ? 'readonly ' : '',
    '[',
    r.parameters ? a : '',
    ']',
...
function ey(e, t, n) {
  let { node: r } = e,
    u = !(ee(r.expression) || Ae(r.expression)),
    a = c(['<', E([m, n('typeAnnotation')]), m, '>']),
    s = [k('('), E([m, n('expression')]), m, k(')')];
  return u
    ? Ke([
        [a, n('expression')],
        [a, c(s, { shouldBreak: !0 })],
...
function uy(e, t, n, r) {
  ...
  let { node: u } = e,
    a = yr(e) ? t.originalText.slice(j(u), N(u)) : ny(e, t, n, r);
  if (!a) return '';
  if (ry(u)) return a;
  let s = _(u.decorators),
    o = Pc(e, t, n),
    p = u.type === 'ClassExpression';
  if (s && !p) return Pn(a, D => c([o, D]));
  let l = Ge(e, t),
    y = Zl(e, t);
  return !o && !l && !y
    ? a
    : Pn(a, D => [y ? ';' : '', l ? '(' : '', l && p && s ? [E([x, o, D]), x] : [o, D], l ? ')' : '']);
}
var Yr = uy,
  ay = { experimental_avoidAstMutation: !0 },
  sy = [
    {
      name: 'JSON.stringify',
      type: 'data',
...
function as(e, t) {
  ...
  if (n === 'ObjectProperty') {
    let { key: r } = e;
    r.type === 'Identifier'
      ? (t.key = { type: 'StringLiteral', value: r.name })
      : r.type === 'NumericLiteral' && (t.key = { type: 'StringLiteral', value: String(r.value) });
    return;
  }
...
var Tt = {
  ...
  Dy = {
    ...
    bracketSameLine: Tt.bracketSameLine,
    objectWrap: Tt.objectWrap,
    bracketSpacing: Tt.bracketSpacing,
    jsxBracketSameLine: {
      category: qe,
      type: 'boolean',
    ...
    singleQuote: Tt.singleQuote,
    jsxSingleQuote: { category: qe, type: 'boolean', default: !1, description: 'Use single quotes in JSX.' },
    quoteProps: {
      category: qe,
      type: 'choice',
      default: 'as-needed',
    ...
    singleAttributePerLine: Tt.singleAttributePerLine,
  },
  yy = Dy,
  dy = { estree: Zr, 'estree-json': us },
  fy = [...Ds, ...sy];
export { cs as default, fy as languages, yy as options, dy as printers };
