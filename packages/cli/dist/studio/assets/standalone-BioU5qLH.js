var $u = Object.create,
  ...
  Wu = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
  Ue = (e, t) => {
  ...
  Ku = (e, t, u, r) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let n of Ru(t))
        !Vu.call(e, n) && n !== u && Xe(e, n, { get: () => t[n], enumerable: !(r = Ju(t, n)) || r.enumerable });
    return e;
  },
  zu = (e, t, u) => ((u = e != null ? $u(Mu(e)) : {}), Ku(Xe(u, 'default', { value: e, enumerable: !0 }), e)),
  Xu = Wu((e, t) => {
    ...
    ((d =
      ...
      (u = /(\x23?)(?=[$_\p{ID_Start}\\])(?:[$_\u200C\u200D\p{ID_Continue}]+|\\u[\da-fA-F]{4}|\\u\{[\da-fA-F]+\})+/uy),
      (E = /(['"])(?:[^'"\\\n\r]+|(?!\1)['"]|\\(?:\r\n|[^]))*(\1)?/y),
      (c =
      ...
      (t.exports = function* (y, { jsx: w = !1 } = {}) {
        ...
        for ({ length: se } = y, v = 0, B = '', k = [{ tag: 'JS' }], x = [], ue = 0, A = !1; v < se; ) {
            ...
            case 'InterpolationInJSX':
              if (y[v] === '/' && (b.test(B) || i.test(B)) && ((d.lastIndex = v), (h = d.exec(y)))) {
                ((v = d.lastIndex),
                  (B = h[0]),
                  (A = !0),
                  yield { type: 'RegularExpressionLiteral', value: h[0], closed: h[1] !== void 0 && h[1] !== '\\' });
                continue;
              }
              if (((F.lastIndex = v), (h = F.exec(y)))) {
                switch (((he = h[0]), (le = F.lastIndex), (N = he), he)) {
                  case '(':
                    (B === '?NonExpressionParenKeyword' && k.push({ tag: 'JSNonExpressionParen', nesting: ue }),
                      ue++,
                      (A = !1));
                    break;
                  case ')':
                    (ue--,
                      ...
                      P.tag === 'JSNonExpressionParen' &&
                        ue === P.nesting &&
                        (k.pop(), (N = '?NonExpressionParenEnd'), (A = !1)));
                    break;
                  case '{':
                      ...
                      case 'InterpolationInTemplate':
                        if (x.length === P.nesting) {
                          ((g.lastIndex = v),
                            ...
                            (B = h[0]),
                            h[1] === '${'
                              ? ((B = '?InterpolationInTemplate'),
                                (A = !1),
                                yield { type: 'TemplateMiddle', value: h[0] })
                              : (k.pop(), (A = !0), yield { type: 'TemplateTail', value: h[0], closed: h[1] === '`' }));
                          continue;
                        }
                        break;
                      case 'InterpolationInJSX':
              ...
              if (((u.lastIndex = v), (h = u.exec(y)))) {
                ...
                ((B = N),
                  (A = !i.test(h[0])),
                  yield { type: h[1] === '#' ? 'PrivateIdentifier' : 'IdentifierName', value: h[0] });
                continue;
              }
              if (((E.lastIndex = v), (h = E.exec(y)))) {
                ((v = E.lastIndex),
                  (B = h[0]),
                  (A = !0),
                  yield { type: 'StringLiteral', value: h[0], closed: h[2] !== void 0 });
                continue;
              }
              ...
              if (((g.lastIndex = v), (h = g.exec(y)))) {
                ((v = g.lastIndex),
                  ...
                  h[1] === '${'
                    ? ((B = '?InterpolationInTemplate'),
                      k.push({ tag: 'InterpolationInTemplate', nesting: x.length }),
                      (A = !1),
                      yield { type: 'TemplateHead', value: h[0] })
                    : ((A = !0), yield { type: 'NoSubstitutionTemplate', value: h[0], closed: h[1] === '`' }));
                continue;
              }
              break;
            case 'JSXTag':
            case 'JSXTagEnd':
              if (((n.lastIndex = v), (h = n.exec(y)))) {
                switch (((v = n.lastIndex), (N = h[0]), h[0])) {
                  ...
                  case '>':
                    (k.pop(),
                      B === '/' || P.tag === 'JSXTagEnd' ? ((N = '?JSX'), (A = !0)) : k.push({ tag: 'JSXChildren' }));
                    break;
                  case '{':
                  ...
                  case '/':
                    B === '<' &&
                      (k.pop(), k[k.length - 1].tag === 'JSXChildren' && k.pop(), k.push({ tag: 'JSXTagEnd' }));
                }
            ...
            case 'JSXChildren':
              ...
              switch (y[v]) {
                case '<':
                  ...
                  continue;
                case '{':
                  (k.push({ tag: 'InterpolationInJSX', nesting: x.length }),
                    v++,
                    (B = '?InterpolationInJSX'),
                    (A = !1),
          ...
          if (((s.lastIndex = v), (h = s.exec(y)))) {
            ((v = s.lastIndex),
              (A = !1),
              o.test(B) && (B = '?NoLineTerminatorHere'),
              yield { type: 'LineTerminatorSequence', value: h[0] });
            continue;
          }
          if (((l.lastIndex = v), (h = l.exec(y)))) {
            ((v = l.lastIndex),
              f.test(h[0]) && ((A = !1), o.test(B) && (B = '?NoLineTerminatorHere')),
              yield { type: 'MultiLineComment', value: h[0], closed: h[1] !== void 0 });
            continue;
          }
          ...
          ((L = String.fromCodePoint(y.codePointAt(v))),
            (v += L.length),
            (B = L),
            (A = !1),
            yield { type: P.tag.startsWith('JSX') ? 'JSXInvalid' : 'Invalid', value: L });
        }
      }));
  }),
  Uu = {};
...
var me =
    (e, t) =>
    (u, r, ...n) =>
      u | 1 && r == null ? void 0 : (t.call(r) ?? r[e]).apply(r, n),
  qu =
  ...
  Gu = class {
    diff(e, t, u = {}) {
      ...
      let n = this.castInput(e, u),
        ...
        a = this.removeEmpty(this.tokenize(n, u)),
        i = this.removeEmpty(this.tokenize(D, u));
    ...
    diffWithOptionsObj(e, t, u, r) {
      ...
      let l = (n = u.timeout) !== null && n !== void 0 ? n : 1 / 0,
        f = Date.now() + l,
        c = [{ oldPos: -1, lastComponent: void 0 }],
        F = this.extractCommon(c[0], t, e, 0, u);
      ...
      let d = -1 / 0,
        ...
        E = () => {
          for (let g = Math.max(d, -o); g <= Math.min(p, o); g += 2) {
            ...
            if (
              (!w || (y && b.oldPos < C.oldPos)
                ? (m = this.addToPath(C, !0, !1, 0, u))
                : (m = this.addToPath(b, !1, !0, 1, u)),
              (F = this.extractCommon(m, t, e, g, u)),
              m.oldPos + 1 >= i && F + 1 >= a)
            )
    ...
    addToPath(e, t, u, r, n) {
      ...
      return D && !n.oneChangePerToken && D.added === t && D.removed === u
        ? {
            oldPos: e.oldPos + r,
            lastComponent: { count: D.count + 1, added: t, removed: u, previousComponent: D.previousComponent },
          }
        : { oldPos: e.oldPos + r, lastComponent: { count: 1, added: t, removed: u, previousComponent: D } };
    }
    extractCommon(e, t, u, r, n) {
      ...
      return (
        s &&
          !n.oneChangePerToken &&
          (e.lastComponent = { count: s, previousComponent: e.lastComponent, added: !1, removed: !1 }),
        (e.oldPos = i),
        o
      );
    }
...
var lr = me('at', function () {
  ...
  H = 'indent-if-break',
  G = 'line-suffix',
  Y = 'line-suffix-boundary',
  I = 'line',
  V = 'label',
  j = 'break-parent',
  Vt = new Set([ee, X, U, q, _, M, T, H, G, Y, I, V, j]);
function cr(e) {
  let t = e.length;
  for (
    ;
...
var oe = fr,
  Fr = e => new Intl.ListFormat('en-US', { type: 'disjunction' }).format(e);
function dr(e) {
      ...
      switch (a) {
        ...
        case _:
          if (r && D.expandedStates)
            for (let i = D.expandedStates.length, o = i - 1; o >= 0; --o) n.push(D.expandedStates[o]);
...
function W(e) {
  ...
  return e.type === T
    ? { ...e, breakContents: W(e.breakContents), flatContents: W(e.flatContents) }
    : e.type === _
      ? { ...e, contents: W(e.contents), expandedStates: e.expandedStates?.map(W) }
      : e.type === M
        ? { type: 'fill', parts: e.parts.map(W) }
        : e.contents
          ? { ...e, contents: W(e.contents) }
          : e;
}
function $r(e) {
  ...
  function r(D, a, i) {
    ...
    if (D.type === U)
      return D.n === Number.NEGATIVE_INFINITY
        ? 'dedentToRoot(' + r(D.contents) + ')'
        : D.n < 0
          ? 'dedent(' + r(D.contents) + ')'
          : D.n.type === 'root'
            ? 'markAsRoot(' + r(D.contents) + ')'
            : 'align(' + JSON.stringify(D.n) + ', ' + r(D.contents) + ')';
    if (D.type === T)
      return (
        'ifBreak(' +
        r(D.breakContents) +
        (D.flatContents ? ', ' + r(D.flatContents) : '') +
        (D.groupId ? (D.flatContents ? '' : ', ""') + `, { groupId: ${n(D.groupId)} }` : '') +
        ')'
      );
    if (D.type === H) {
      let o = [];
    ...
    if (D.type === _) {
      ...
      let s = o.length > 0 ? `, { ${o.join(', ')} }` : '';
      return D.expandedStates
        ? `conditionalGroup([${D.expandedStates.map(l => r(l)).join(',')}]${s})`
        : `group(${r(D.contents)}${s})`;
    }
...
function qr(e, t, u) {
  ...
  let r;
  return (
    typeof t == 'number' ? (t < 0 ? (r = Ur) : (r = { type: 2, width: t })) : (r = { type: 3, string: t }),
    Qt(e, r, u)
  );
}
function Hr(e, t) {
  ...
  for (; u >= 0; ) {
    ...
    switch (c) {
      ...
      case _: {
        ...
        let F = f.break ? O : l,
          d = f.expandedStates && F === O ? S(0, f.expandedStates, -1) : f.contents;
        o.push({ mode: F, doc: d });
        break;
      }
      case T: {
...
`,
      ...
      case _:
        switch (b) {
          ...
          case O: {
            o = !1;
            let y = { indent: m, mode: J, doc: C.contents },
              w = r - D,
              x = s.length > 0;
              ...
              if (C.break) {
                ...
                for (let $ = 1; $ < C.expandedStates.length + 1; $++)
                  if ($ >= C.expandedStates.length) {
                    ...
                    let v = C.expandedStates[$],
                      B = { indent: m, mode: J, doc: v };
                    if (Be(B, a, w, x, u)) {
                      a.push(B);
                      break;
                    }
      ...
      case M: {
        ...
        let $ = x[w + 0],
          v = x[w + 1],
          B = { indent: m, mode: J, doc: $ },
          se = { indent: m, mode: O, doc: $ },
          h = Be(B, [], y, s.length > 0, u, !0);
        if (L === 1) {
          h ? a.push(B) : a.push(se);
          break;
        }
        let P = { indent: m, mode: J, doc: v },
          le = { indent: m, mode: O, doc: v };
        if (L === 2) {
          h ? a.push(P, B) : a.push(le, se);
          break;
        }
        let N = x[w + 2],
          ue = { indent: m, mode: b, doc: { ...C, [We]: w + 2 } },
          A = Be({ indent: m, mode: J, doc: [$, v, N] }, [], y, s.length > 0, u, !0);
      ...
      case I:
        switch (b) {
          ...
          case O:
            ...
            C.literal
              ? ((i += n), (D = 0), m.root && (m.root.value && (i += m.root.value), (D = m.root.length)))
              : (g(), (i += n + m.value), (D = m.length));
            break;
        }
        break;
      case V:
  ...
  function g() {
    ...
    (m && (f.push(m), (F += m.length)),
      (i = ''),
      (D -= b),
      l.length > 0 && (c.push(...l.map(C => Math.min(C, F))), (l.length = 0)));
  }
}
function Yr(e, t, u = 0) {
  let r = 0;
...
function uu(e, t, u) {
  ...
  if (!n) return [];
  let D,
    a = (u.getChildren?.(e, u) ?? [..._e(e, { getVisitorKeys: u.getVisitorKeys })]).flatMap(
      s => (D ?? (D = [e, ...t]), n(s, D) ? [s] : uu(s, D, u)),
    ),
    { locStart: i, locEnd: o } = u;
...
function ln(e, t) {
  ...
  let r = [],
    ...
    { ownLine: i = Pe, endOfLine: o = Pe, remaining: s = Pe } = D,
    l = u.map((f, c) => ({
      ...Du(e, f, t),
      comment: f,
      text: a,
  ...
  for (let [f, c] of l.entries()) {
    let {
      ...
      y;
    if (
      (n ? (y = [c]) : ((F.enclosingNode = p), (F.precedingNode = d), (F.followingNode = E), (y = [F, g, m, b, C])),
      cn(g, m, l, f))
    )
      ((F.placement = 'ownLine'), i(...y) || (E ? ge(E, F) : d ? Ee(d, F) : re(p || b, F)));
...
function ht(e, t) {
  ...
  let { precedingNode: r, followingNode: n } = e[0],
    ...
    a;
  for (a = u; a > 0; --a) {
    let { comment: i, precedingNode: o, followingNode: s } = e[a - 1],
      l = t.originalText.slice(t.locEnd(i), D);
...
function dn(e, t) {
  let u = e.node,
    r = [iu(e, t)],
    { printer: n, originalText: D, locStart: a, locEnd: i } = t;
...
function pn(e, t, u) {
  let r = e.node,
    n = iu(e, t),
    { printer: D, originalText: a, locStart: i } = t,
    o = D.isBlockComment?.(r);
  if ((u?.hasLineSuffix && !u?.isBlock) || Q(a, i(r), { backwards: !0 })) {
    let s = rt(a, i(r));
    return { doc: Ve([K, s ? K : '', n]), isBlock: o, hasLineSuffix: !0 };
  }
  return !o || u?.hasLineSuffix
    ? { doc: [Ve([' ', n]), Ne], isBlock: o, hasLineSuffix: !0 }
    : { doc: [' ', n], isBlock: o, hasLineSuffix: !1 };
}
function hn(e, t) {
  let u = e.node;
  if (!u) return {};
...
function su({ plugins: e = [], showDeprecated: t = !1 } = {}) {
  let u = e.flatMap(n => n.languages ?? []),
    r = [];
  for (let n of yn(Object.assign({}, ...e.map(({ options: D }) => D), En)))
    (!t && n.deprecated) ||
      (Array.isArray(n.choices) &&
        (t || (n.choices = n.choices.filter(D => !D.deprecated)),
        n.name === 'parser' && (n.choices = [...n.choices, ...mn(n.choices, u, e)])),
      (n.pluginDefaults = Object.fromEntries(
        e.filter(D => D.defaultOptions?.[n.name] !== void 0).map(D => [D.name, D.defaultOptions[n.name]]),
      )),
      r.push(n));
  ...
  for (let n of t)
    if (n.parsers) {
      for (let D of n.parsers)
        if (!r.has(D)) {
          r.add(D);
          let a = u.find(o => o.parsers && Object.prototype.hasOwnProperty.call(o.parsers, D)),
            i = n.name;
...
function xn(e) {
  e = lu(e);
  let t = decodeURIComponent(e.pathname.replace(/\//g, '\\').replace(/%(?![0-9A-Fa-f]{2})/g, '%25')).replace(
    /^\\*([A-Za-z]:)(\\|$)/,
    '$1\\',
  );
...
var In = e => String(e).split(/[/\\]/u).pop(),
  Nn = e => String(e).startsWith('file:');
function gt(e, t) {
  if (!t) return;
  let u = In(t).toLowerCase();
  return (
    e.find(({ filenames: r }) => r?.some(n => n.toLowerCase() === u)) ??
    e.find(({ extensions: r }) => r?.some(n => u.endsWith(n)))
  );
}
function On(e, t) {
  if (t)
...
var cu = Tn,
  fe = {
    ...
    pair: ({ key: e, value: t }) => fe.value({ [e]: t }),
  },
  nt = new Proxy(String, { get: () => nt }),
  R = nt,
  fu = () => nt,
  Pn = (e, t, { descriptor: u }) => {
    let r = [`${R.yellow(typeof e == 'string' ? u.key(e) : u.pair(e))} is deprecated`];
    return (
      t && r.push(`we now treat it as ${R.blue(typeof t == 'string' ? u.key(t) : u.pair(t))}`),
      r.join('; ') + '.'
    );
  },
  Fu = Symbol.for('vnopts.VALUE_NOT_EXIST'),
  we = Symbol.for('vnopts.VALUE_UNCHANGED'),
  mt = ' '.repeat(2),
  jn = (e, t, u) => {
    let { text: r, list: n } = u.normalizeExpectedResult(u.schemas[e].expected(u)),
      D = [];
    return (
      r && D.push(yt(e, t, r, u.descriptor)),
      n &&
        D.push(
          [yt(e, t, n.title, u.descriptor)].concat(n.values.map(a => du(a, u.loggerPrintWidth))).join(`
`),
        ),
...
function yt(e, t, u, r) {
  return [
    `Invalid ${R.red(r.key(e))} value.`,
    `Expected ${R.blue(u)},`,
    `but received ${t === Fu ? R.gray('nothing') : R.red(r.value(t))}.`,
  ].join(' ');
}
function du({ text: e, list: t }, u) {
  ...
  return (
    ...
    t &&
      r.push(
        [`- ${R.blue(t.title)}:`].concat(t.values.map(n => du(n, u - mt.length).replace(/^|\n/g, `$&${mt}`))).join(`
`),
      ),
    pu(r, u)
  );
...
function $e(e, t, u) {
  ...
  for (; F < a; ) {
    for (o = t.charCodeAt(i + F), l = F++, s = F, c = 0; c < D; c++)
      ((f = o === Le[c] ? l : l + 1), (l = ce[c]), (s = ce[c] = l > s ? (f > s ? s + 1 : f) : f > l ? l + 1 : f));
    if (r !== void 0) {
      let d = s;
...
function Ln(e, t, u) {
  ...
  for (let o of t) {
    ...
    if (s >= a || s > r) continue;
    let l = Number.isFinite(a) ? Math.min(a, r) : r,
      f = l === void 0 ? $e(e, o) : $e(e, o, { maxDistance: l });
    if (f > r) continue;
    let c = f;
...
var hu = (e, t, { descriptor: u, logger: r, schemas: n }) => {
    let D = [`Ignored unknown option ${R.yellow(u.pair({ key: e, value: t }))}.`],
      a = Ln(e, Object.keys(n), { maxDistance: 3 });
  ...
  Wn = class extends te {
    ...
    expected(e) {
      ...
      return {
        ...
        list: u && { title: 'an array of the following values', values: [{ list: u }] },
      };
    }
    validate(e, t) {
...
function Cu(e) {
  ...
  let { text: t, list: u } = e;
  return (
    Qn((t || u) !== void 0, 'Unexpected `expected` result, there should be at least one field.'),
    u ? { text: t, list: { title: u.title, values: u.values.map(Cu) } } : { text: t }
  );
}
function bt(e, t) {
  ...
  aD = class {
    constructor(e, t) {
      ...
      ((this._utils = {
        ...
        loggerPrintWidth: r,
        schemas: zn(e, 'name'),
        normalizeDefaultResult: Bt,
        normalizeExpectedResult: Cu,
        normalizeDeprecatedResult: At,
        normalizeForwardResult: Ke,
        normalizeRedirectResult: kt,
        normalizeValidateResult: bt,
      }),
        (this._unknownHandler = D),
        (this._invalidHandler = Yn(a)),
        (this._deprecatedHandler = i),
        (this._identifyMissing = (c, F) => !(c in F) || o(c, F)),
    ...
    normalize(e) {
      let t = {},
        ...
        r = () => {
          for (; u.length !== 0; ) {
            let n = u.shift(),
              D = this._applyNormalization(n, t);
            u.push(...D);
          }
        };
      r();
    ...
    _applyNormalization(e, t) {
      ...
      for (let D of r) {
        let a = this._utils.schemas[D],
          i = a.preprocess(e[D], this._utils);
    ...
    _applyRequiredCheck(e) {
      for (let t of Object.keys(this._utils.schemas))
        if (this._identifyMissing(t, e) && this._identifyRequired(t)) throw this._invalidHandler(t, Fu, this._utils);
    }
...
function iD(e, t, { logger: u = !1, isCLI: r = !1, passThrough: n = !1, FlagSchema: D, descriptor: a } = {}) {
  ...
  let i = n
      ? Array.isArray(n)
        ? (c, F) => (n.includes(c) ? { [c]: F } : void 0)
        : (c, F) => ({ [c]: F })
      : (c, F, d) => {
          let { _: p, ...E } = d.schemas;
          return hu(c, F, { ...d, schemas: E });
        },
    o = oD(t, { isCLI: r, FlagSchema: D }),
    s = new aD(o, { logger: u, unknown: i, descriptor: a }),
    l = u !== !1;
...
function oD(e, { isCLI: t, FlagSchema: u }) {
  ...
  for (let n of e)
    (r.push(sD(n, { isCLI: t, optionInfos: e, FlagSchema: u })),
      n.alias && t && r.push(Mn.create({ name: n.alias, sourceName: n.name })));
  return r;
}
function sD(e, { isCLI: t, optionInfos: u, FlagSchema: r }) {
  ...
  switch (e.type) {
    ...
    case 'choice':
      ((a = Zn),
        (D.choices = e.choices.map(o =>
          o?.redirect ? { ...o, redirect: { to: { key: e.name, value: o.redirect } } } : o,
        )));
      break;
    case 'boolean':
      a = Kn;
  ...
  if (
    (e.exception
      ? (D.validate = (o, s, l) => e.exception(o) || s.validate(o, l))
      : (D.validate = (o, s, l) => o === void 0 || s.validate(o, l)),
    e.redirect &&
      (i.redirect = o =>
        o
  ...
  return e.array
    ? Wn.create({ ...(t ? { preprocess: o => (Array.isArray(o) ? o : [o]) } : {}), ...i, valueSchema: a.create(D) })
    : a.create({ ...D, ...i });
}
var lD = iD,
  cD =
  ...
  gu = fD,
  FD = Symbol.for('PRETTIER_IS_FRONT_MATTER'),
  dD = [];
function pD(e) {
  return !!e?.[FD];
}
var Dt = pD,
  Eu = new Set(['yaml', 'toml']),
  mu = ({ node: e }) => Dt(e) && Eu.has(e.language);
...
var mD = ED,
  yu = new Set(['tokens', 'comments', 'parent', 'enclosingNode', 'precedingNode', 'followingNode']),
  yD = e => Object.keys(e).filter(t => !yu.has(t));
function vD(e, t) {
  let u = e ? r => e(r, yu) : yD;
...
function AD(e) {
  ...
  if (r) {
    ...
    s = new Proxy(r, {
      get(F, d, p) {
        return d === 'getVisitorKeys'
          ? (c ?? (c = r.getVisitorKeys ? St(r.getVisitorKeys, i.massageAstNode || i.embed) : u), c)
          : Reflect.get(F, d, p);
      },
...
var wD = ['clean', 'embed', 'print'],
  kD = Object.fromEntries(wD.map(e => [e, !1]));
function xD(e) {
  return { ...kD, ...e };
}
function SD(e) {
  return {
    ...
    ...e,
    experimental_frontMatterSupport: xD(e?.experimental_frontMatterSupport),
  };
}
...
async function ID(e, t = {}) {
  ...
  if (!u.parser)
    if (u.filepath) {
      if (((u.parser = cu(u, { physicalFile: u.filepath })), !u.parser))
        throw new Ct(`No parser could be inferred for file "${u.filepath}".`);
    } else throw new Ct("No parser and no file path given, couldn't infer a parser.");
  let r = su({ plugins: e.plugins, showDeprecated: !0 }).options,
    n = { ...It, ...Object.fromEntries(r.filter(f => f.default !== void 0).map(f => [f.name, f.default])) },
    D = vu(u.plugins, u.parser),
    a = await Bu(D, u.parser);
  ((u.astFormat = a.astFormat), (u.locEnd = a.locEnd), (u.locStart = a.locStart));
  let i = D.printers?.[a.astFormat] ? D : BD(u.plugins, a.astFormat),
    o = await bD(i, a.astFormat);
  ((u.printer = o), (u.getVisitorKeys = o.getVisitorKeys));
  let s = i.defaultOptions ? Object.fromEntries(Object.entries(i.defaultOptions).filter(([, f]) => f !== void 0)) : {},
    l = { ...n, ...s };
...
function bu(e) {
  return {
    ...
    regex: e.magenta,
    comment: e.gray,
    invalid: be(be(e.white, e.bgRed), e.bold),
    gutter: e.gray,
    marker: be(e.red, e.bold),
    message: be(e.red, e.bold),
    reset: e.reset,
  };
}
bu(fu());
...
function OD(e, t, u) {
  let r = Object.assign({ column: 0, line: -1 }, e.start),
    ...
    { linesAbove: D = 2, linesBelow: a = 3 } = u || {},
    i = r.line,
    o = r.column,
    s = n.line,
    l = n.column,
    f = Math.max(i - (D + 1), 0),
    c = Math.min(t.length, s + a);
...
function _D(e, t, u = {}) {
  let r = ND(),
    n = e.split(Nt),
    { start: D, end: a, markerLines: i } = OD(t, n, u),
    o = t.start && typeof t.start.column == 'number',
    s = String(a).length,
    l = e
      .split(Nt, a)
      .slice(D, a)
      .map((f, c) => {
        ...
        if (p) {
          let g = '';
          if (Array.isArray(p)) {
            let m = f.slice(0, Math.max(p[0] - 1, 0)).replace(/[^\t]/g, ' '),
              b = p[1] || 1;
            ((g = [
              `
 `,
              r.gutter(d.replace(/\d/g, ' ')),
              ' ',
              m,
              r.marker('^').repeat(b),
            ].join('')),
              E && u.message && (g += ' ' + r.message(u.message)));
          }
...
function $D(e, t, u, r) {
  let { originalText: n, [Symbol.for('comments')]: D, locStart: a, locEnd: i, [Symbol.for('printedComments')]: o } = t,
    { node: s } = e,
    l = a(s),
    f = i(s);
...
function Ot(e, t, u, r, n) {
  let { node: D } = e,
    ...
    i;
  switch (
    (a.hasPrettierIgnore?.(e) ? (i = JD(e, t, u, r)) : n.has(D) ? (i = n.get(D)) : (i = a.print(e, t, u, r)), D)
  ) {
    case t.cursorNode:
      i = Ae(i, o => [De, o, De]);
      break;
...
async function Au(e, t) {
  let u = e.comments ?? [];
  ((t[Symbol.for('comments')] = u), (t[Symbol.for('printedComments')] = new Set()), ln(e, t));
  let {
...
function MD(e, t) {
  ...
  function a(i, o) {
    ...
    let s = {},
      l = new Set(n(i));
    for (let c in i)
      !Object.prototype.hasOwnProperty.call(i, c) || D?.has(c) || (l.has(c) ? (s[c] = a(i[c], i)) : (s[c] = i[c]));
    let f = r(i, s, o);
...
var VD = MD,
  ...
  zD = KD,
  XD = ({ parser: e }) => e === 'json' || e === 'json5' || e === 'jsonc' || e === 'json-stringify';
function UD(e, t) {
...
function YD(e, t, u) {
  let { rangeStart: r, rangeEnd: n, locStart: D, locEnd: a } = t,
    i = e.slice(r, n).search(/\S/u),
    o = i === -1;
...
async function Su(e, t, u = 0) {
  ...
  if (u > 0) {
    ...
    (a.cursorNodeStart !== void 0 &&
      ...
      a.cursorNodeStart < 0 && ((a.cursorNodeStart = 0), (a.cursorNodeText = a.cursorNodeText.trimStart())),
      a.cursorNodeStart + a.cursorNodeText.length > o.length && (a.cursorNodeText = a.cursorNodeText.trimEnd())),
      (a.formatted = o + He(t.endOfLine)));
  }
...
`,
    ...
    l = await Su(
      a,
      {
        ...
        cursorOffset: t.cursorOffset > n && t.cursorOffset <= D ? t.cursorOffset - n : -1,
        endOfLine: 'lf',
      },
      s,
    ),
...
function Iu(e, t) {
  let { cursorOffset: u, rangeStart: r, rangeEnd: n, endOfLine: D } = jt(e, t),
    a = e.charAt(0) === xu;
...
async function Nu(e, t) {
  ...
  if (
    (n.rangeStart >= n.rangeEnd && r !== '') ||
    (n.requirePragma && !(await Lt(r, n))) ||
    (n.checkIgnorePragma && (await ZD(r, n)))
  )
    return { formatted: e, cursorOffset: t.cursorOffset, comments: [] };
  let D;
  return (
    n.rangeStart > 0 || n.rangeEnd < r.length
      ? (D = await QD(r, n))
      : (!n.requirePragma &&
          n.insertPragma &&
          n.printer.insertPragma &&
          !(await Lt(r, n)) &&
          (r = n.printer.insertPragma(r)),
        (D = await Su(r, n))),
    u && ((D.formatted = xu + D.formatted), D.cursorOffset >= 0 && D.cursorOffset++),
    D
  );
}
async function ea(e, t, u) {
  let { text: r, options: n } = Iu(e, await pe(t)),
    D = await ve(r, n);
...
async function ua(e, t) {
  let u = $r(e),
    { formatted: r } = await Nu(u, { ...t, parser: '__js_expression' });
  return r;
}
...
var Da = {
    ...
    indentIfBreak: _r,
    align: de,
    addAlignmentToDoc: zt,
    markAsRoot: Kt,
    dedentToRoot: xr,
    dedent: Sr,
    hardlineWithoutBreakParent: Qe,
    literallineWithoutBreakParent: Ht,
    label: Tr,
    concat: e => e,
  },
  aa = { printDocToString: Oe },
  ia = {
    willBreak: gr,
    traverseDoc: Ge,
    findInDoc: Ye,
...
Ue(_u, {
  ...
  addLeadingComment: () => ge,
  addTrailingComment: () => Ee,
  getAlignmentSize: () => et,
  getIndentSize: () => da,
  getMaxContinuousCount: () => Ca,
  getNextNonSpaceNonCommentCharacter: () => Ea,
  getNextNonSpaceNonCommentCharacterIndex: () => Sa,
  getPreferredQuote: () => Ba,
  getStringWidth: () => Ze,
  hasNewline: () => Q,
  hasNewlineInRange: () => Aa,
  hasSpaces: () => ka,
  isNextLineEmpty: () => Ta,
  isNextLineEmptyAfterIndex: () => ct,
  isPreviousLineEmpty: () => Na,
  makeString: () => _a,
  skip: () => ye,
  skipEverythingButNewLine: () => tu,
...
var Ea = ga,
  ...
  Pu = Object.freeze({ character: '"', codePoint: 34 }),
  ma = Object.freeze({ preferred: Tu, alternate: Pu }),
  ya = Object.freeze({ preferred: Pu, alternate: Tu });
function va(e, t) {
  let { preferred: u, alternate: r } = t === !0 || t === "'" ? ma : ya,
    { length: n } = e,
    D = 0,
    a = 0;
  for (let i = 0; i < n; i++) {
...
var ja = ne(su, 0),
  La = { parse: ne(ea), formatAST: ne(ta), formatDoc: ne(ua), printToDoc: ne(ra), printDocToString: ne(na) };
export {
  La as __debug,
  Pa as check,
  Uu as default,
