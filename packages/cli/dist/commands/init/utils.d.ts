...
export declare function promptForObservability(
  command?: 'create' | 'init',
...
export declare function writeAgentSample(
...
export declare function writeCodeSampleForComponents(
  llmprovider: LLMProvider,
  component: Component,
  destPath: string,
...
export declare const writeIndexFile: ({
  dirPath,
  addAgent,
  addExample,
  addWorkflow,
...
export declare const writeAPIKey: ({ provider, apiKey }: { provider: LLMProvider; apiKey?: string }) => Promise<void>;
/**
 ...
 */
export declare const writeObservabilityEnv: ({
  token,
  projectId,
  endpoint,
}?: {
...
>;
export declare const writeCodeSample: (
  dirPath: string,
  component: Component,
  llmProvider: LLMProvider,
  importComponents: Component[],
 ...
 */
export declare function generateAgentsMarkdown({
  skills,
  mcpServer,
}: {
  skills?: string[];
 ...
 */
export declare function writeAgentsMarkdown(options: { skills?: string[]; mcpServer?: Editor }): Promise<void>;
/**
