...
export declare function fetchServerDeployStatus(
  deployId: string,
  token: string,
  orgId?: string,
): Promise<ServerDeployStatus>;
export declare function fetchServerDeployDiagnosis(
  deployId: string,
  token: string,
  orgId?: string,
...
export declare function uploadServerDeploy(
  token: string,
  orgId: string,
  projectId: string,
  zipBuffer: Buffer,
...
export declare function pollServerDeploy(
  deployId: string,
  token: string,
  orgId: string,
  maxWaitMs?: number,
): Promise<ServerDeployStatus>;
export declare function getServerProjectEnv(
  token: string,
  orgId: string,
  projectId: string,
): Promise<Record<string, string>>;
export declare function updateServerProjectEnv(
  token: string,
  orgId: string,
  projectId: string,
  envVars: Record<string, string>,
): Promise<void>;
export declare function fetchServerProjectDetail(
  token: string,
  orgId: string,
  projectId: string,
): Promise<{
